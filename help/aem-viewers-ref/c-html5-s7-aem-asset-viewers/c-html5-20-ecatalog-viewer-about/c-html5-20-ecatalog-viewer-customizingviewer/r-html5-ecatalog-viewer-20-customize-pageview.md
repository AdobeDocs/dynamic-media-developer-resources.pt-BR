...
É possível configurar a exibição do cursor do mouse personalizado sobre a área do visualizador principal. Essa funcionalidade é controlada com os seletores de atributos adicionais aplicados a `.s7ecatalogviewer .s7pageview` Classe CSS:

...
Ao selecionar ou tocar nesse botão, o zoom é ampliado em uma imagem na exibição principal. Este botão não é exibido em telefones celulares para salvar propriedades de tela. Você pode dimensionar, aplicar a capa e posicionar esse botão usando o CSS.
...
Exemplo - Para configurar um botão de saída de zoom com 28 x 28 pixels e é posicionado 4 pixels da parte inferior e 75 pixels da borda direita da barra de controle principal. E finalmente, exibe uma imagem diferente para cada um dos quatro estados de botão diferentes.

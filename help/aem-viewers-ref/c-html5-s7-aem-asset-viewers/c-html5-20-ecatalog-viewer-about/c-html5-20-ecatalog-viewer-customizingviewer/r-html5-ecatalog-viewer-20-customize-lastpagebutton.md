...
Selecionar ou tocar nesse botão traz o usuário para a última página no catálogo. Este botão aparece na barra de controle principal em sistemas de desktop e tablets; em telefones celulares é adicionado a uma barra de controle secundária. Você pode dimensionar, aplicar a capa e posicionar esse botão usando o CSS.
...
Exemplo - Para configurar um botão da última página com 28 x 28 pixels e é posicionado 4 pixels da parte inferior e 220 pixels da borda esquerda da barra de controle principal. E finalmente, exibe uma imagem diferente para cada um dos quatro estados de botão diferentes.

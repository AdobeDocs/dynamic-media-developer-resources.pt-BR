---
description: Clicar ou tocar nesse botão leva o usuário para a primeira página do catálogo. Este botão aparece na barra de controle principal em sistemas de desktop e tablets; em telefones celulares é adicionado a uma barra de controle secundária. Você pode dimensionar, exibir e posicionar esse botão usando o CSS.
seo-description: Clicar ou tocar nesse botão leva o usuário para a primeira página do catálogo. Este botão aparece na barra de controle principal em sistemas de desktop e tablets; em telefones celulares é adicionado a uma barra de controle secundária. Você pode dimensionar, exibir e posicionar esse botão usando o CSS.
...
Clicar ou tocar nesse botão leva o usuário para a primeira página do catálogo. Este botão aparece na barra de controle principal em sistemas de desktop e tablets; em telefones celulares é adicionado a uma barra de controle secundária. Você pode dimensionar, exibir e posicionar esse botão usando o CSS.
...
Exemplo - para configurar um botão de primeira página com 28 x 28 pixels, posicionado 4 pixels da parte inferior e 220 pixels da borda esquerda da barra de controle principal e exibe uma imagem diferente para cada um dos quatro estados de botão diferentes.

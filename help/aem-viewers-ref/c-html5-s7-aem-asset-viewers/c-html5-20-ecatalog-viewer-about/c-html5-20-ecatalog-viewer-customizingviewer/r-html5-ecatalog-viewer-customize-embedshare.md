...
Exemplo - Para configurar o cabeçalho da caixa de diálogo com o preenchimento, um ícone de 24 x 14 pixels e um título de 16 pontos em negrito. E um botão Fechar de 28 x 28 pixels, posicionado dois pixels da parte superior e dois pixels da direita do contêiner de diálogo:
...
Incorporar rótulo de tamanho e lista suspensa são posicionados na parte inferior da caixa de diálogo e colocados em um contêiner controlado com o seguinte seletor de classe CSS:

...
Exemplo - Para configurar um menu Favoritos posicionado em quatro pixels da parte superior da barra de controle e em dez pixels do botão mais próximo à esquerda e dimensionado em 28 x 28 pixels:
...
Exemplo - Para configurar um botão de menu Favoritos que exibe uma imagem diferente para cada um dos quatro estados de botão diferentes:

...
Este visualizador é totalmente acessível pelo teclado, conforme descrito em [Navegação e acessibilidade do teclado](../../c-keyboard-accessibility.md#topic-f5650e9493404e55a3627c8d1366b861).
...
1. Definir o tamanho do visualizador
   ...
   Você pode definir o tamanho estático do visualizador declarando-o para a classe CSS de nível superior `.s7ecatalogviewer` em unidades absolutas ou usando o modificador `stagesize`.
...
Na incorporação de tamanho flexível com largura e altura definidas, o estilo da página da Web é diferente. Ou seja, ele fornece ambos os tamanhos ao &quot; titular&quot; `DIV` e centraliza na janela do navegador. Além disso, a página da Web define o tamanho do elemento `HTML` e `BODY` como 100%:

...
Por exemplo, se você planeja ouvir o `StatusEvent.NOTF_VIEW_READY` evento e o visualizador for servido da SPS, o tipo de evento totalmente qualificado será exibido `s7classic.s7sdk.event.StatusEvent.NOTF_VIEW_READY`e o código do ouvinte do evento será semelhante ao seguinte:

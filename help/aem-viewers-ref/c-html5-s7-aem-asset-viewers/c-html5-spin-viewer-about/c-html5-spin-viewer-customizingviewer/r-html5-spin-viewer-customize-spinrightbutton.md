...
description: Clicar ou tocar nesse botão gira a imagem para a direita na exibição principal. Este botão não é exibido em telefones celulares para salvar o espaço na tela. Além disso, o botão fica oculto quando um conjunto de rotação multidimensional é usado. Você pode dimensionar, aplicar capa e posicionar o botão usando CSS.
...
# Botão Girar para a direita{#spin-right-button}

Clicar ou tocar nesse botão gira a imagem para a direita na exibição principal. Este botão não é exibido em telefones celulares para salvar o espaço na tela. Além disso, o botão fica oculto quando um conjunto de rotação multidimensional é usado. Você pode dimensionar, aplicar capa e posicionar o botão usando CSS.

<!--<a id="section_061E550C1C1D4DB2BD663A898895B38C"></a>-->

**Propriedades CSS dos botões de rotação**
...
Exemplo - Para configurar um botão de rotação à direita com 28 x 28 pixels e posicionado na borda direita do contêiner interno. Por fim, o exibe uma imagem diferente para cada um dos quatro estados de botão diferentes:

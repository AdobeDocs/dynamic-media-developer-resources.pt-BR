---
description: O Visualizador de zoom básico oferece suporte ao rastreamento do Adobe Analytics na caixa.
seo-description: O Visualizador de zoom básico oferece suporte ao rastreamento do Adobe Analytics na caixa.
...
O Visualizador de zoom básico oferece suporte ao rastreamento do Adobe Analytics na caixa.

## Rastreamento predefinido {#section-ba994f079d0343c8ae48adffaa3195a3}

O Visualizador de zoom básico suporta o [!DNL Adobe Analytics] rastreamento predefinido. Para ativar o rastreamento, passe o nome predefinido de empresa como `config2` parâmetro.

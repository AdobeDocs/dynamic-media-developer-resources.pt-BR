...
seo-description: O realce do foco de entrada exibido em torno do elemento de interface de uso do visualizador focado é controlado com o seletor de classe CSS.

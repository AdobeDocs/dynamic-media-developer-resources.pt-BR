---
title: Botão Fechar
description: Selecionar esse botão fecha a página da Web que contém. Esse botão só aparecerá se o parâmetro closebutton estiver definido como 1. Você pode dimensionar, aplicar a capa e posicionar esse botão usando o CSS.
...
Exemplo - para configurar um botão Fechar com 32 x 32 pixels e posicionado seis pixels da borda superior e direita do visualizador. Ela deve exibir uma imagem diferente para cada um dos quatro estados de botão diferentes.

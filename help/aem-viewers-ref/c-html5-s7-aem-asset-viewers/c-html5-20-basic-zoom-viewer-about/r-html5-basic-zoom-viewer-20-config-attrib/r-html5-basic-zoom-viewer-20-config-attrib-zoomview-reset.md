...
<table id="table_49FFD1BC53B846F09A6D214BC8C5C3FE"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Redefine a porta de visualização quando o quadro (imagem) muda. Se definido como <span class="varname"> 0</span> , preservará a porta de visualização atual com o melhor ajuste possível, preservando a proporção da imagem recém-definida. </p> </td> 
  </tr> 
 </tbody> 
</table>

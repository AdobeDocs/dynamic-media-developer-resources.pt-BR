...
<table id="table_AE7AAFA9B4374E31B51D06511EB96401"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> A imagem a ser exibida no primeiro quadro antes da reprodução dos start de vídeo foi resolvida em relação ao <span class="codeph"> serverurl</span>. Se especificado no URL, codifique o seguinte por HTTP: </p> <p> 

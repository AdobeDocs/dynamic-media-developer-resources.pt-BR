---
title: Personalização do Visualizador de mídia mista
description: Toda personalização visual e a maioria dos comportamentos do Visualizador de mídia mista são feitos com a criação de um CSS personalizado.
keywords: responsivo
...
# Personalização do Visualizador de mídia mista{#customizing-mixed-media-viewer}

Toda personalização visual e a maioria dos comportamentos do Visualizador de mídia mista são feitos com a criação de um CSS personalizado.
...
O segundo grupo de marcadores CSS inclui `.s7mouseinput` e `.s7touchinput`. O `.s7touchinput` classe é definida se o dispositivo atual tiver recursos de entrada de toque; caso contrário, `.s7mouseinput` é usada. Esses marcadores são destinados a criar elementos de entrada da interface do usuário com tamanhos de tela diferentes para tipos de entrada diferentes, pois normalmente a entrada por toque requer elementos maiores. Caso o dispositivo tenha recursos de entrada e toque do mouse, `.s7touchinput` é definida e o visualizador renderiza uma interface de usuário fácil de tocar.
...
O uso de marcadores de CSS é a maneira mais flexível de criar CSS projetado e responsivo. Isso ocorre porque permite direcionar não apenas o tamanho da tela do dispositivo, mas o tamanho real do visualizador, o que pode ser útil para layouts de página de design responsivos.
...
Veja a seguir a documentação de referência dos elementos da interface do usuário que se aplica ao Visualizador de mídias mistas:

...
seo-description: A área de visualização principal é a área ocupada pela exibição principal e as amostras. Geralmente, ele é definido para ajustar a tela de dispositivo disponível quando nenhum tamanho é especificado.

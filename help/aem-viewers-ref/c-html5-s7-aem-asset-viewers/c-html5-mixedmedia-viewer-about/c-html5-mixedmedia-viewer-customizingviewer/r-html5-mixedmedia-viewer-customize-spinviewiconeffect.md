---
title: Efeito de ícone da exibição de rotação
description: O indicador de rotação é sobreposto na área de exibição de rotação. Ela é exibida quando a imagem está em um estado redefinido e também depende do parâmetro iconeffect.
...
# Efeito de ícone da exibição de rotação{#spin-view-icon-effect}

O indicador de rotação é sobreposto na área de exibição de rotação. Ela é exibida quando a imagem está em um estado redefinido e também depende do parâmetro iconeffect.

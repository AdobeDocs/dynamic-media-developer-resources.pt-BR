...
Selecionar esse botão gira a imagem para a esquerda na exibição principal. Este botão não é exibido em telefones celulares para salvar propriedades de tela. Além disso, o botão fica oculto quando um conjunto de rotação multidimensional é usado. É possível dimensionar, usar a capa e posicionar o botão usando o CSS.
...
Exemplo - Para configurar um botão girar à esquerda com 28 x 28 pixels e é posicionado na borda esquerda do contêiner interno. E, por fim, exibe uma imagem diferente para cada um dos quatro estados de botão diferentes:

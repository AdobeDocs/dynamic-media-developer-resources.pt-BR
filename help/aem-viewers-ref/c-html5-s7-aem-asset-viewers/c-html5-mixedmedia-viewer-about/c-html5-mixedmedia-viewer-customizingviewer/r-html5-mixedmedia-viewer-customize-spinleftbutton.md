...
Selecionar esse botão gira a imagem para a esquerda na exibição principal. Este botão não é exibido em telefones celulares para salvar o espaço na tela. Além disso, o botão fica oculto quando um conjunto de rotação multidimensional é usado. Você pode dimensionar, aplicar capa e posicionar o botão usando CSS.

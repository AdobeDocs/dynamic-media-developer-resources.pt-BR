...
A seleção deste botão diminui o zoom de uma imagem na visualização principal. Esse botão não é exibido em telefones celulares para salvar o espaço na tela. Você pode dimensionar, aplicar capa e posicionar esse botão usando CSS.

...
Alterna entre ativar e desativar a exibição da legenda fechada. Não é visível se o parâmetro da legenda não for especificado. Você pode usar o CSS para dimensionar, usar a capa e posicionar esse botão em relação à barra de controle que o contém.
...
Exemplo - para configurar um botão de legenda fechada com 28 x 28 pixels, posicionado quatro pixels da parte superior e 68 pixels da borda direita da barra de controle, e exibe uma imagem diferente para cada um dos quatro estados de botão diferentes quando selecionado ou não selecionado.

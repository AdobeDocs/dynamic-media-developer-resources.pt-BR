---
description: Alterna entre ativar e desativar a exibição da legenda. Não é visível se o parâmetro de legenda não for especificado. Você pode usar o CSS para dimensionar, exibir e posicionar esse botão em relação à barra de controle que o contém.
seo-description: Alterna entre ativar e desativar a exibição da legenda. Não é visível se o parâmetro de legenda não for especificado. Você pode usar o CSS para dimensionar, exibir e posicionar esse botão em relação à barra de controle que o contém.
...
Alterna entre ativar e desativar a exibição da legenda. Não é visível se o parâmetro de legenda não for especificado. Você pode usar o CSS para dimensionar, exibir e posicionar esse botão em relação à barra de controle que o contém.
...
>[!NOTE]
>
>Este botão suporta o seletor de `state` atributos e os seletores de atributos selecionados, que podem ser usados para aplicar diferentes capas a diferentes estados de botão. Em particular, `selected='true'` corresponde ao estado quando as legendas estão visíveis e `selected='false'` são usadas quando as legendas estão ocultas.
...
Exemplo - para configurar um botão de legenda com 28 x 28 pixels, posicionado quatro pixels da parte superior e 68 pixels da borda direita da barra de controle, e exibe uma imagem diferente para cada um dos quatro estados de botão diferentes quando selecionado ou não selecionado.

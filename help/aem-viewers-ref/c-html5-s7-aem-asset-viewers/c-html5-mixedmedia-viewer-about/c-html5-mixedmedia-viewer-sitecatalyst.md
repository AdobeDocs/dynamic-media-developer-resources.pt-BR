---
description: O Mixed Media Viewer oferece suporte ao Adobe Analytics para rastreamento imediato.
seo-description: O Mixed Media Viewer oferece suporte ao Adobe Analytics para rastreamento imediato.
...
O Mixed Media Viewer oferece suporte ao Adobe Analytics para rastreamento imediato.

## Rastreamento predefinido {#section-ba994f079d0343c8ae48adffaa3195a3}

O Mixed Media Viewer suporta o [!DNL Adobe Analytics] rastreamento predefinido. Para ativar o rastreamento, passe o nome predefinido de empresa como `config2` parâmetro.

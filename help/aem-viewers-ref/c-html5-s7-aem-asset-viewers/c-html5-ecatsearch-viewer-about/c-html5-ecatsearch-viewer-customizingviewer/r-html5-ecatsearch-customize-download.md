...
**Propriedades de CSS do botão Download**
...
Exemplo - para configurar um botão Download de 28 x 28 pixels e exibir uma imagem diferente para cada um dos quatro estados de botão diferentes:

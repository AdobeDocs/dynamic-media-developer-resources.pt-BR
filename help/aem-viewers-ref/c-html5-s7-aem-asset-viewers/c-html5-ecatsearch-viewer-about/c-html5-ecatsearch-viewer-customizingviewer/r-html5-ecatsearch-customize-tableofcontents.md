---
title: Índice
description: Índice é um botão na barra de controle principal. Quando ativado, um painel suspenso é exibido com uma lista de índices e rótulos de página.
...
Índice é um botão na barra de controle principal. Quando ativado, um painel suspenso é exibido com uma lista de índices e rótulos de página.
...
A aparência e comportamento individual do item são controladas com o seguinte seletor de classe CSS:
...
Se houver mais itens que possam caber verticalmente no painel suspenso - e o sistema for uma área de trabalho - o componente renderiza uma barra de rolagem vertical no lado direito do painel. A aparência da área da barra de rolagem é controlada com o seguinte seletor de classe CSS:

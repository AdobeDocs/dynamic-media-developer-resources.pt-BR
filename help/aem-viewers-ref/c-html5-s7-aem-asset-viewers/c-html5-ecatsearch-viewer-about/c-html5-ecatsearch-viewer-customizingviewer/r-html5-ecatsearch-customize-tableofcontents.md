---
title: Índice
description: O índice é um botão na barra de controle principal. Quando ativado, um painel suspenso é exibido com uma lista de índices e rótulos de página.
...
O índice é um botão na barra de controle principal. Quando ativado, um painel suspenso é exibido com uma lista de índices e rótulos de página.
...
Exemplo - Configure um botão de sumário posicionado a 4 pixels da parte inferior e a 43 pixels da esquerda da barra de controle principal. O tamanho é de 28 x 28 pixels e uma imagem diferente é exibida para cada um dos quatro estados de botão diferentes:
...
A aparência e comportamento do item individual são controlados com o seguinte seletor de classe CSS:

...
description: Selecionar esse botão traz o usuário para a última página no catálogo. Esse botão aparece na barra de controle principal em sistemas desktop e tablets; em telefones celulares, ele é adicionado a uma barra de controle secundária. Você pode dimensionar, aplicar capa e posicionar esse botão usando CSS.
...
Selecionar esse botão traz o usuário para a última página no catálogo. Esse botão aparece na barra de controle principal em sistemas desktop e tablets; em telefones celulares, ele é adicionado a uma barra de controle secundária. Você pode dimensionar, aplicar capa e posicionar esse botão usando CSS.

...
description: A seleção deste botão diminui o zoom de uma imagem na visualização principal. Esse botão não é exibido em celulares para salvar espaço na tela. Você pode dimensionar, aplicar capa e posicionar esse botão usando CSS.
...
A seleção deste botão diminui o zoom de uma imagem na visualização principal. Esse botão não é exibido em celulares para salvar espaço na tela. Você pode dimensionar, aplicar capa e posicionar esse botão usando CSS.
...
Exemplo - Para configurar um botão de zoom de 28 x 28 pixels, posicionado a 4 pixels da parte inferior e a 75 pixels da borda direita da barra de controle principal. Por fim, o exibe uma imagem diferente para cada um dos quatro estados de botão diferentes.

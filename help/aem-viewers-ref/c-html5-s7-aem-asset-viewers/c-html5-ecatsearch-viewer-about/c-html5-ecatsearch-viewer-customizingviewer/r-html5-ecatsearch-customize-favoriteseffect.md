...
Em sistemas desktop, o componente suporta o seletor de `cursortype` atributos que você pode aplicar à `.s7favoriteseffect` classe e controla o tipo do cursor com base na ação do usuário selecionado. Os seguintes `cursortype` valores são suportados:

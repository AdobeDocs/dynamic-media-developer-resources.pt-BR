...
Define um novo ativo. Você pode chamar este parâmetro a qualquer momento, antes ou depois de [!DNL `init()`]. Se for chamado depois de [!DNL `init()`], o visualizador trocará o ativo no tempo de execução.

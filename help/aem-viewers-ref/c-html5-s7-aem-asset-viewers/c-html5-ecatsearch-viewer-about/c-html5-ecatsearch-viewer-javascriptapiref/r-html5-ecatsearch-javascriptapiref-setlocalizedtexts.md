...
[!DNL ` setLocalizedTexts( *`informaçõesDeLocalização`*)`]
...
Define valores de SYMBOL de localização para um ou mais locais. Este parâmetro deve ser chamado antes de [!DNL `init()`].

...
Exemplo - Para configurar um botão de saída de zoom com 32 x 32 pixels e posicionado seis pixels da borda superior e direita do visualizador. E finalmente, exibe uma imagem diferente para cada um dos quatro estados de botão diferentes.

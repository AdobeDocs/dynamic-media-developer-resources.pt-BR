---
description: Toda personalização visual e a maioria dos comportamentos do Visualizador de zoom são feitos com a criação de um CSS personalizado.
keywords: responsive
seo-description: Toda personalização visual e a maioria dos comportamentos do Visualizador de zoom são feitos com a criação de um CSS personalizado.
...
Toda personalização visual e a maioria dos comportamentos do Visualizador de zoom são feitos com a criação de um CSS personalizado.
...
Ao criar um CSS personalizado, lembre-se de que o visualizador atribui a `.s7zoomviewer` classe ao elemento DOM do container. Se você estiver usando um arquivo CSS externo transmitido com `style=` comando, use a classe `.s7zoomviewer` como classe pai no seletor descendente para suas regras CSS. Se você estiver fazendo estilos incorporados na página da Web, qualifice adicionalmente este seletor com uma ID do elemento DOM do container da seguinte maneira:

...
Exemplo - Para configurar o cabeçalho da caixa de diálogo com o preenchimento, ícone de 24 x 14 pixels, negrito e 16 pontos. E finalmente, um botão de fechamento de 28 x 28 pixels, posicionado dois pixels da parte superior e dois pixels da direita do contêiner da caixa de diálogo:
...
As dicas de ferramentas dos rótulos da caixa de diálogo podem ser localizadas. Consulte [Localização dos elementos da interface do usuário](../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad) para obter mais informações.
...
Exemplo - Para configurar o código incorporado para que seja usado `break-word` quebra automática de palavra:
...
Exemplo - Para definir a caixa de combinação de tamanho de incorporação com largura de 300 pixels ao mostrar um item predefinido e 110 pixels de largura ao mostrar um tamanho personalizado:
...
Exemplo - Para definir os campos de entrada de tamanho personalizado para ter uma borda cinza, margem, preenchimento e 70 pixels de largura de um pixel:

...
No exemplo de código acima, o nível de volume é definido como `0` no componente `mutableVolume`. Em seguida, o mesmo componente é desativado para que não possa ser usado pelo usuário final.

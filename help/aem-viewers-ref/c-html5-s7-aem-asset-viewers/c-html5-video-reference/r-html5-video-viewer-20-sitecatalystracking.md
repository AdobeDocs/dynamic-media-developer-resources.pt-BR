---
description: O Visualizador de vídeo oferece suporte ao Adobe Analytics para rastreamento imediato.
seo-description: O Visualizador de vídeo oferece suporte ao Adobe Analytics para rastreamento imediato.
...
O Visualizador de vídeo oferece suporte ao Adobe Analytics para rastreamento imediato.
...
Para integrar sistemas de análise de terceiros, é necessário ouvir o retorno de chamada do `trackEvent` visualizador e processar `eventInfo` o argumento da função de retorno de chamada, conforme necessário. O código a seguir é um exemplo dessa função de manipulador:

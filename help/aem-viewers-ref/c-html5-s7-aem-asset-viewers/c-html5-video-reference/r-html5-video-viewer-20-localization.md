---
description: Determinado conteúdo exibido pelo Visualizador de vídeo está sujeito a localização. Esse conteúdo inclui dicas de ferramentas de elementos da interface do usuário e uma mensagem de erro que é exibida quando o vídeo não pode ser reproduzido.
seo-description: Determinado conteúdo exibido pelo Visualizador de vídeo está sujeito a localização. Esse conteúdo inclui dicas de ferramentas de elementos da interface do usuário e uma mensagem de erro que é exibida quando o vídeo não pode ser reproduzido.
...
Determinado conteúdo exibido pelo Visualizador de vídeo está sujeito a localização. Esse conteúdo inclui dicas de ferramentas de elementos da interface do usuário e uma mensagem de erro que é exibida quando o vídeo não pode ser reproduzido.
...
O código da página da Web deve passar esse objeto de localização para o construtor do visualizador como um valor do `localizedTexts` campo do objeto de configuração. Uma opção alternativa é passar o objeto de localização chamando o `setLocalizedTexts(localizationInfo)` método.
...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dica de ferramenta para o estado de pausa de reprodução desmarcado. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dica de ferramenta para o volume silencioso desmarcado. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dica de ferramenta para o estado de botão de tela cheia desmarcado. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dica de ferramenta para a mensagem de erro exibida no caso de o endereço de email estar malformado. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dica de ferramenta para o botão Fechar exibida na parte inferior da caixa de diálogo após o envio do formulário. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dica de ferramenta para o botão de compartilhamento incorporado. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dica de ferramenta para o botão de compartilhamento do Facebook. </p> </td> 
  </tr> 
  <tr> 

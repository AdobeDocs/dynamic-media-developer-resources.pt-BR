...
Define novo vídeo externo e dados de vídeo adicionais opcionais. Pode ser chamado a qualquer momento, antes e depois `init()`. Se chamado depois `init()`, o visualizador alterna o vídeo em tempo de execução.

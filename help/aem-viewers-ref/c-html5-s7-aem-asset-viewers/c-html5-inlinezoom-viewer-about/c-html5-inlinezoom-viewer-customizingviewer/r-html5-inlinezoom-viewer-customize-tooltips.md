...
>[!NOTE]
>
>Se os estilos de dica de ferramenta forem personalizados na página da Web de incorporação, todas as propriedades deverão conter `!IMPORTANT` regra. No entanto, não é necessário se as dicas de ferramentas forem personalizadas no arquivo CSS do visualizador.

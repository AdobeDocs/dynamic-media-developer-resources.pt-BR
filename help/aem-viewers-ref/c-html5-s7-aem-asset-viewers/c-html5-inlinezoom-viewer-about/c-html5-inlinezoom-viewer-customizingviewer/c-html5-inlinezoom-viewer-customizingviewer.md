---
title: Personalizando o Visualizador de Zoom em Linha
description: Personalizando o Visualizador de Zoom em Linha
keywords: responsivo
...
# Personalizando o Visualizador de Zoom em Linha{#customizing-inline-zoom-viewer}
...
Também é importante preservar a seguinte declaração CSS do CSS do visualizador padrão, pois é necessária para a funcionalidade de zoom em linha:
...
O uso de marcadores CSS é a maneira mais flexível de criar CSS responsivo projetado. Ele permite direcionar não apenas o tamanho da tela do dispositivo, mas o tamanho real do visualizador, que pode ser útil para layouts responsivos de página da Web projetados.
...
Com uma abordagem clássica de estilo, o CSS teria uma referência separada a um arquivo de imagem individual no servidor para cada estado do elemento da interface do usuário. Este é um exemplo de CSS para criar o estilo de um botão de rolagem:

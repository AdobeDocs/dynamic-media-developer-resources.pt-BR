---
title: getComponent
description: Referência da API do JavaScript para o Visualizador de zoom incorporado
...
Referência da API do JavaScript para o Visualizador de zoom incorporado
...
Ao trabalhar com APIs de SDK, é importante usar corretamente o namespace de SDK totalmente qualificado, conforme descrito no [Visualizador de SDK](../../../c-html5-s7-aem-asset-viewers/c-html5-inlinezoom-viewer-about/c-html5-inlinezoom-viewer-namespace.md#concept-5af3b472b320496d87735ea612edda80).

Consulte a documentação do Visualizador SDK para obter mais informações sobre um componente específico.

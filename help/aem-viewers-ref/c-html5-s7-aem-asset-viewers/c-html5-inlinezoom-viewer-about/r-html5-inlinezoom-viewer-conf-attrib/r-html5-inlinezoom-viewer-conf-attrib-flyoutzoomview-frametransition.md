...
<table id="table_FC34B37AACFB4E92A37E1D2D93D5F0D2"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> </p> <p> Especifica o tipo do efeito aplicado à exibição principal na alteração do ativo. </p> <p><span class="codeph"> nenhum</span> significa sem transição, a mudança de exibição principal acontece instantaneamente. </p> <p><span class="codeph"> fade</span> ativa a transição cross-fade onde a imagem antiga desaparece e a nova imagem aparece </p> <p> </p> </td> 
  </tr> 
  <tr> 

...
>[!NOTE]
>
>Caso os estilos de dica de ferramenta sejam personalizados na página da Web de incorporação, todas as propriedades precisam conter `!IMPORTANT` regra. No entanto, não é necessário se as dicas de ferramentas forem personalizadas no arquivo CSS do visualizador.

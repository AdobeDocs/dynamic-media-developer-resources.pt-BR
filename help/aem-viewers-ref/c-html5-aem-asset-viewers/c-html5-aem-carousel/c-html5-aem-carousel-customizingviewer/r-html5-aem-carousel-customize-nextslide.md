...
Este botão não é exibido em dispositivos de toque. Você pode dimensionar, aplicar capa e posicionar esse botão usando CSS.
...
Por exemplo, suponha que você queira configurar um botão de slide anterior com 60 x 60 pixels. Você deseja que o botão seja posicionado dez pixels a partir da borda direita do visualizador e centralizado verticalmente. E deseja exibir uma imagem diferente para cada um dos quatro estados de botão diferentes.

...
O botão é visível somente se o `CarouselViewer.autoplay` parâmetro estiver definido como `1`; caso contrário, está oculta. É possível dimensionar, aplicar a capa e posicionar esse botão, em relação à barra de controle que o contém, usando o CSS.

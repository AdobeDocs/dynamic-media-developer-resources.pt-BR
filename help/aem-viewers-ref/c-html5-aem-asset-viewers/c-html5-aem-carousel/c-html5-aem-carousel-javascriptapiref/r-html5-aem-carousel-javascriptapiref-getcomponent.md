...
Ao trabalhar com APIs de SDK, é importante usar o namespace de SDK totalmente qualificado correto, conforme descrito em [Namespace do visualizador do SDK](../../../c-html5-aem-asset-viewers/c-html5-aem-carousel/c-html5-aem-carousel-namespace.md).

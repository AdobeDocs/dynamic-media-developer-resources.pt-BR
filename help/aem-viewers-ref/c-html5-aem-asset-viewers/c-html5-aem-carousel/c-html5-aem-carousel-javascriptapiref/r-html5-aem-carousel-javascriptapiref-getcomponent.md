...
Ao trabalhar com APIs do SDK, é importante usar o namespace do SDK totalmente qualificado correto, conforme descrito em [Namespace SDK do visualizador](../../../c-html5-aem-asset-viewers/c-html5-aem-carousel/c-html5-aem-carousel-namespace.md).

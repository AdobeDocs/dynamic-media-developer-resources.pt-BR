...
seo-description: O controle de volume mutável aparece inicialmente como um botão que permite que o usuário mude ou mude o som do player de vídeo.
seo-title: Volume variável
...
**Exemplos**  - Para configurar um botão Mudo que tenha 32 x 32 pixels e seja posicionado 6 pixels da parte superior e 38 pixels da borda direita da barra de controle. Exiba uma imagem diferente para cada um dos quatro estados de botão diferentes quando selecionado ou não selecionado.

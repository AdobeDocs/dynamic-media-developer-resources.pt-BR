...
O visualizador suporta dois mecanismos de criação de CSS responsivo projetado: marcadores CSS e consultas de mídia CSS padrão. É possível usar marcadores ou consultas independentemente ou juntos.

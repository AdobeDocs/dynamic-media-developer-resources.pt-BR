---
description: Toda personalização visual e a maior parte do comportamento do visualizador do Video360 é feita criando um CSS personalizado.
keywords: responsive
seo-description: Toda personalização visual e a maior parte do comportamento do visualizador do Video360 é feita criando um CSS personalizado.
seo-title: Personalização do visualizador Video360
solution: Experience Manager
title: Personalização do visualizador Video360
topic: Dynamic media
...
# Personalização do visualizador Video360{#customizing-video-viewer}

Toda personalização visual e a maior parte do comportamento do visualizador do Video360 é feita criando um CSS personalizado.
...
Ao criar um CSS personalizado, lembre-se de que o visualizador atribui a `.s7video360viewer` classe ao elemento DOM do container. Se você estiver usando um arquivo CSS externo transmitido com `style=` comando, use a classe `.s7video360viewer` como classe pai no seletor descendente para suas regras CSS. Se você estiver fazendo estilos incorporados na página da Web, qualifice adicionalmente este seletor com uma ID do elemento DOM do container da seguinte maneira:
...
Quando aplicados a visualizadores móveis HTML5, use quatro query de mídia CSS, definidos em seu CSS, na ordem listada abaixo:
...
A seguir estão os elementos da interface do usuário que fazem referência à documentação que se aplica ao visualizador do Video360:

...
**Exemplo** - Para configurar um botão de tela cheia com 32 x 32 pixels e posicionado 6 pixels a partir da borda superior e direita da barra de controle. Além disso, exibe uma imagem diferente para cada um dos quatro estados de botão diferentes quando selecionado ou não selecionado.

...
**Exemplo** - Para configurar um botão de tela cheia com 32 x 32 pixels e posicionado a 6 pixels da borda superior e direita da barra de controle. Além disso, exiba uma imagem diferente para cada um dos quatro estados de botão diferentes quando selecionado ou não.

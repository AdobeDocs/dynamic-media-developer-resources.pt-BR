...
O &quot;botão&quot; do depurador também se move conforme o vídeo é reproduzido, para indicar a posição atual do vídeo durante a reprodução. O depurador de vídeo sempre ocupa toda a largura da barra de controle. É possível retirar a pele do depurador de vídeo. Altere sua altura e posição vertical por CSS.
...
**Exemplo** - Para configurar um visualizador de vídeo com um depurador de vídeo com cores de faixa personalizadas de dez pixels de altura. E posicione-o a dez pixels e 35 pixels das bordas superior e esquerda da barra de controle.

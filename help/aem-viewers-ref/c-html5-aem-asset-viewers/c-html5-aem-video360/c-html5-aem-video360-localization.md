...
description: Determinado conteúdo exibido pelo visualizador está sujeito a localização. Esse conteúdo inclui dicas de ferramentas do elemento da interface do usuário e uma mensagem de erro exibida quando o vídeo não pode ser reproduzido.
...
Determinado conteúdo exibido pelo visualizador está sujeito a localização. Esse conteúdo inclui dicas de ferramentas do elemento da interface do usuário e uma mensagem de erro exibida quando o vídeo não pode ser reproduzido.
...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>O botão incorporar compartilhamento. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>A última entrada de "tamanho personalizado" na caixa de combinação de tamanho incorporado. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>O botão Compartilhar do Facebook. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> TwitterShare.TOOLTIP </span> </p> </td> 
   <td colname="col2"> <p>O botão Twitter share. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> Video360Player.ERROR </span> </p> </td> 
   <td colname="col2"> <p>A mensagem de erro que é exibida quando não é possível reproduzir vídeo. </p> </td> 
  </tr> 
 </tbody> 
</table>

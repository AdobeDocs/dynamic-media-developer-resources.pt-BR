...
Define novo vídeo externo. Pode ser chamado a qualquer momento, antes e depois `init()`. Se chamado após `init()`, o visualizador troca o vídeo em tempo de execução.

...
Ao trabalhar com APIs do SDK, é importante usar a namespace SDK totalmente qualificada correta, conforme descrito na namespace [do SDK do](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621)visualizador.

Consulte a documentação da API *do SDK do visualizador* HTML5 para obter mais informações sobre um componente específico.

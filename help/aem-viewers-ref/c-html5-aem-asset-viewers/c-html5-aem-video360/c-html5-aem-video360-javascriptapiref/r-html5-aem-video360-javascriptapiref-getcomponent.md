...
Ao trabalhar com APIs do SDK, é importante usar o namespace do SDK totalmente qualificado e correto, conforme descrito em [Namespace do SDK do visualizador](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621).

Consulte a documentação da *API do SDK do Visualizador do HTML5* para obter mais informações sobre um componente específico.

## Devoluções {#section-1d3cf85bc7cc4dfe9670e038d02b9101}

O `{Object}` é uma referência ao componente SDK do Visualizador. O método retornará `null` se `componentId` não for um componente de visualizador com suporte ou se o componente ainda não tiver sido criado pela lógica do visualizador.

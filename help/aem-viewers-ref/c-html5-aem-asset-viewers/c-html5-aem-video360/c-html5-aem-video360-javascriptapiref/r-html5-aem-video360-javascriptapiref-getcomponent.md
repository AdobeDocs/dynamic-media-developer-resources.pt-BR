...
Ao trabalhar com APIs de SDK, é importante usar o namespace de SDK totalmente qualificado e correto, conforme descrito em [Namespace do visualizador do SDK](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621).

Consulte a *API do SDK do visualizador do HTML5* para obter mais informações sobre um componente específico.

## Devoluções {#section-1d3cf85bc7cc4dfe9670e038d02b9101}

A variável `{Object}` é uma referência ao componente de SDK do Visualizador. O método retorna `null` se a variável `componentId` não é um componente de visualizador compatível ou se o componente ainda não foi criado pela lógica do visualizador.

...
Ao trabalhar com APIs do SDK, é importante usar o namespace do SDK totalmente qualificado e correto, conforme descrito no [Namespace do SDK do visualizador]

...
Dependendo do método de publicação de vídeos do Dynamic Media usado no Adobe Experience Manager, o atributo de configuração `SmartCropVideoPlayer.ssl` é aplicado de forma diferente, conforme demonstrado a seguir:

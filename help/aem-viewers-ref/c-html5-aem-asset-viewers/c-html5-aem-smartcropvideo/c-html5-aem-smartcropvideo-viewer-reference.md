...
É recomendável usar uma página de HTML para o modo de operação pop-up. É chamado de [!DNL SmartCropVideoViewer.html] e está localizado sob o [!DNL html5/] subpasta da implantação padrão do IS-Viewers:
...
1. Adicionar o arquivo JavaScript do visualizador à página da Web.
   ...
   A criação de um visualizador exige a adição de uma tag de script no cabeçalho de HTML. Antes de usar a API do visualizador, inclua [!DNL SmartCropVideoViewer.js]. A variável [!DNL SmartCropVideoViewer.js] O arquivo está localizado sob o [!DNL html5/js/] subpasta da implantação padrão do IS-Viewers:
...
1. Definir o tamanho do visualizador
   ...
   Consulte [Personalização do visualizador de vídeo de recorte inteligente](../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/c-html5-video-viewer-20-customizingviewer/c-html5-video-viewer-20-customizingviewer.md#concept-072a52b10b5f4c0789393dc6e2134c0e) para obter mais informações sobre como estilizar o visualizador usando CSS.

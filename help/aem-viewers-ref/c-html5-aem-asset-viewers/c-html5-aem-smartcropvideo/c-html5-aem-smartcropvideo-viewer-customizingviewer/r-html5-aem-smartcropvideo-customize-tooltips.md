...
>[!NOTE]
>
>Se os estilos de dica de ferramenta forem personalizados na página da Web de incorporação, todas as propriedades deverão conter uma `!IMPORTANT` regra. Essa regra não é necessária se as dicas de ferramentas forem personalizadas no arquivo CSS do visualizador.

Exemplo - para configurar dicas de ferramentas com uma borda cinza com raio de canto de 3 pixels, plano de fundo preto e texto branco escrito com Arial®, tamanho de 11 pixels:

...
Para configurar um botão Reproduzir/Pausar com 32 x 32 pixels e posicionado a seis pixels da borda superior e esquerda da barra de controle. Por fim, exibe uma imagem diferente para cada um dos quatro estados de botão diferentes quando selecionados ou não selecionados.

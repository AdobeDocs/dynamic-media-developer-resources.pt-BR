...
A dica de ferramenta do depurador de vídeo pode ser localizada. Consulte [Localização de elementos](../../../c-html5-aem-asset-viewers/c-html5-aem-int-video/c-html5-aem-int-video-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) da interface do usuário para obter mais informações.
...
Quando a captação de vídeo é ativada com o `navigation` parâmetro, os locais do capítulo são exibidos como marcadores na parte superior da faixa do depurador de vídeo.
...
>[!NOTE]
>
>Este botão suporta o seletor de `state` atributos, que você pode usar para aplicar diferentes capas a diferentes estados de botão. Em particular, `selected='default'` corresponde ao estado padrão do marcador do capítulo do vídeo e `selected='over'` é usado quando o marcador do capítulo do vídeo é ativado por um gesto de mouse sobre ou toque.
...
<table id="table_BC6AFB57D9404A84A3AE657448C0EB06"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Define apenas uma margem inferior negativa. Deve ter o mesmo valor que o da largura da <span class="codeph"> borda </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>

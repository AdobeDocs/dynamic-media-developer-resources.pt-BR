...
**Propriedades CSS da caixa de diálogo Botão Cancelar**
...
**Exemplo** - para configurar um rodapé de caixa de diálogo com um botão Cancelar de 64 x 34, com cores de texto e de plano de fundo diferentes para cada estado de botão:
...
**Exemplo** - para configurar uma área da caixa de diálogo principal com 300 pixels de altura, tenha uma margem de 10 pixels e use um plano de fundo branco:
...
**Exemplo** - para configurar todos os rótulos para serem cinza, negrito com fonte de nove pixels:
...
**Exemplo** - para definir a cópia de texto como 430 pixels de largura e ter um preenchimento de 10 pixels na parte inferior:

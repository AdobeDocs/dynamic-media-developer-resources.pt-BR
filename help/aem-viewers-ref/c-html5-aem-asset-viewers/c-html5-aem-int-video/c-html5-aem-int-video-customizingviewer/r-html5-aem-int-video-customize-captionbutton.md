...
Para configurar um botão de legenda oculta com 28 x 28 pixels. O botão deve ser posicionado a quatro pixels da parte superior e a 68 pixels da borda direita da barra de controle. E deve exibir uma imagem diferente para cada um dos quatro estados de botão diferentes quando selecionado ou não selecionado.

...
<table id="table_D4A2035B65B140F882F550B711BD3160"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Acionadores quando a inicialização do visualizador for concluída e todos os componentes internos forem criados, para que seja possível usar a API <span class="codeph"> getComponent() </span>. O manipulador de retorno de chamada não aceita nenhum argumento. </p> </td> 
  </tr> 
  <tr> 

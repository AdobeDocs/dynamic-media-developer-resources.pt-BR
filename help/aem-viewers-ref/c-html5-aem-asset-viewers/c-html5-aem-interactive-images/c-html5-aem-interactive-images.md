...
## Uso do Visualizador de imagens interativo {#section-e6c68406ecdc4de781df182bbd8088b4}
...
## Como incorporar o Visualizador de imagens interativo {#section-6bb5d3c502544ad18a58eafe12a13435}
...
1. Adicionar o arquivo JavaScript do visualizador à sua página da Web.
   ...
   A criação de um visualizador requer a adição de uma tag de script no cabeçalho HTML. Antes de poder usar a API do visualizador, verifique se você incluiu [!DNL InterativeImage.js]. O [!DNL InteractiveImage.js] arquivo está localizado na [!DNL html5/js/] subpasta da implantação padrão do IS-Viewers:
...
1. Definição do tamanho do visualizador
   ...
   Você pode definir o tamanho estático para o visualizador declarando-o para a classe CSS de nível `.s7interactiveimage` superior em unidades absolutas ou usando o `stagesize` modificador.

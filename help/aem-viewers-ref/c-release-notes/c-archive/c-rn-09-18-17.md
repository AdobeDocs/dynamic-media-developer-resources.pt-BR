...
* O valor `native` de `playback` modifier está obsoleto; usar o novo valor `progressive` em vez disso.

* Adição de suporte para reprodução de streaming HTTPS para [!DNL Dynamic Media] vídeo.
...
## Problemas conhecidos e restrições da versão 5.8.2 {#section-af67bc1734844f31a89a09004b558c6e}
...
* A imagem do cartaz pode encontrar um `max size` erro. Aumente a configuração de limite para a publicação do fornecimento de imagem.

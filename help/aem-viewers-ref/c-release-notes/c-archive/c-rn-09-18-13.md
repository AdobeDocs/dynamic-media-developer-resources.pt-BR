...
* Devido a um problema com o Java v.1.5.0_06, o componente do servidor não é compatível com essa versão do Java. [https://bugs.sun.com/bugdatabase/view_bug.do?bug_id=6274990](https://bugs.sun.com/bugdatabase/view_bug.do?bug_id=6274990).
...
* Erro de exceção gerado quando o visualizador é incorporado na página HTTPS. O problema é devido à comunicação com o registro do servidor. Para obter mais informações: [https://helpx.adobe.com/flash-player/kb/flash-player-issues-secure-sockets.html](https://helpx.adobe.com/flash-player/kb/flash-player-issues-secure-sockets.html)

...
* Os usuários veem um prompt na parte superior da página da Web que estão visualizando no Firefox. No prompt, é possível optar por continuar bloqueando o plug-in ou permitir a execução do plug-in, caso em que o vídeo é reproduzido normalmente.
* Definir o reprodutor de vídeo como `playback=native` modo. Isso reproduz o vídeo MP4 progressivamente.

...
* Defina o reprodutor de vídeo como `playback=native` modo. Isso reproduz o vídeo MP4 progressivamente.
...
* Estilo CSS `display:none` em `DIV` contêiner não suportado. Inclui Jquery `hide()` método.

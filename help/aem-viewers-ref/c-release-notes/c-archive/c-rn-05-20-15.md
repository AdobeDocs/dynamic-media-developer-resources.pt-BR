...
seo-title: Notas de versão do Scene7 Viewers 5.2.3
...
**IMPORTANTE:** A versão mais recente do Firefox agora impede que o plug-in Adobe Flash seja executado em sites por padrão. Se você implantou o player de vídeo Scene7 que usa o plug-in Adobe Flash em sistemas de desktop, você tem as três opções a seguir:
...
* Defina o player de vídeo para o `playback=native` modo. Isso reproduz o vídeo MP4 progressivamente.
...
## Problemas conhecidos e restrições para a versão 5.2.2 {#section-368dd0dc138b44e28b49314e4ad0fa1a}

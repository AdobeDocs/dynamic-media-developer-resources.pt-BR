...
## Correções de erros da versão 5.5.2 {#section-50e7ea1e01dd4e1fa9c8b3e00eb002b4}
...
* Adição de suporte para entrada de mouse e toque em execução no navegador Chrome. No entanto, os dispositivos Microsoft Surface pertencem a essa categoria, o Microsoft Edge não funciona com entrada de toque com visualizadores 5.5.
...
## Problemas conhecidos e restrições da versão 5.5.1 {#section-af67bc1734844f31a89a09004b558c6e}
...
* A imagem do cartaz pode encontrar um `max size` erro. Talvez seja necessário aumentar a configuração de limite para a publicação do fornecimento de imagem.

...
* Adicionado suporte para integração com a extensão Adobe Launch Dynamic Media Viewers.
* Adicionado suporte para o modo de operação VR no Oculus Browser para o Video360Viewer.
* Adicionado o evento `RolloverKeyEvent.HREF_ACTIVATED` para permitir que o código do cliente responda à ativação do mapa de imagem no eCatalogViewer e no eCatalogSearchViewer.

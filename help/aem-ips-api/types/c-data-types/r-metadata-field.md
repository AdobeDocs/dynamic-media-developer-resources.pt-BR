...
seo-description: Definições de campo definidas pelo usuário para ativos específicos.
...
Recuperar definições de campo de tag com as operações `getMetadataFields` ou `getAssetMetadataField` .

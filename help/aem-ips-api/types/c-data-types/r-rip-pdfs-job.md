...
>[!NOTE]
>
>Este tipo de tarefa está obsoleto. Transição `ReprocessAssetsJob` para todas as integrações futuras.
...
<table id="table_04100BB8ABD84EF68B0A7CE3AD946414"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Opções para carregar arquivos do Adobe InDesign no servidor de imagens. </p> </td> 
  </tr> 
  <tr> 

...
seo-description: Determina se um ativo está pronto para ser publicado.
...
Determina se um ativo está pronto para ser publicado.

Sintaxe

## Tipos de usuário autorizados {#section-11bec77e50b24461bb8c8aacf016eec8}
...
## Parâmetros {#section-09d2ba001a2a455a9102550272f3eecb}
...
<table id="table_23CB72BFB8984CDF82D7207E7D82FC43"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> Sim </td> 
   <td colname="col4">Estados disponíveis: 

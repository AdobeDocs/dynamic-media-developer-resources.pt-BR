...
<table id="table_2972D1BB9CED4F7F9207747AE8CBAE8D"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> restrictedSubTypeCheck</span></span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:booleano</span> </td> 
   <td colname="col3"> Não </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:booleano</span> </td> 
   <td colname="col3"> Não </td> 
   <td colname="col4"> Se verdadeiro, os ativos de subproduto gerados durante a ingestão de um ativo mestre, como imagens de página em PDF rasgado, serão excluídos dos resultados da pesquisa. O padrão é falso. </td> 
  </tr> 
  <tr> 

...
user-guide-description: A API do Serviço Web IPS (Sistema de Produção de Imagens) permite que aplicativos externos e desenvolvedores de terceiros acessem programaticamente os ativos e funcionalidades do IPS.
...
+ [Sobre a API do sistema de produção de imagens da Dynamic Media](c-overview.md)
...
+ Métodos de operação {#operation-methods}
   ...
   + Parâmetros de operação {#operation-parameters}
      + [Visão geral dos parâmetros de operação](operations/c-operations-intro/c-methods/c-methods.md)
      ...
      + [getAtivePublishContext](operations/c-operations-intro/c-methods/r-get-active-publish-contexts.md)
...
+ Tipos de dados {#data-types}
   ...
   + [AtivoPublicarContextos](types/c-data-types/r-asset-publish-context.md)
   ...
   + [Opções deCortarCorAutomática](types/c-data-types/r-auto-color-crop-options.md)
   ...
   + [Uso de disco](types/c-data-types/r-disk-usage.md)
   + [DiskUsageArray](types/c-data-types/r-disk-usage-array.md)
   + [ConfirmaçãoDeEmail](types/c-data-types/r-email-confirmation.md)
   ...
   + [Palavras-chaveArray](types/c-data-types/r-keywords-array.md)
   + [OpçõesDePlanoDeFundoDeConhecimento](types/c-data-types/r-knockout-background-options.md)
   ...
   + [Evento MPE](types/c-data-types/r-mp-event.md)
   + [MPEeventArray](types/c-data-types/r-mp-event-array.md)
   ...
   + [PDFOoptions](types/c-data-types/r-pdf-options.md)
   ...
   + [PerspectivaQuad](types/c-data-types/r-perspective-quad.md)
   ...
   + [PublicarContexto](types/c-data-types/r-publish-context.md)
   + [PublishContextArray](types/c-data-types/r-publish-context-array.md)
   + [PublicarHistórico](types/c-data-types/r-publish-history.md)
   ...
   + [Opções de miniatura](types/c-data-types/r-thumbnail-options.md)
   + [DescompactarOpções](types/c-data-types/r-uncompress-options.md)
   + [Tirar nitidez deOpçõesDeMáscara](types/c-data-types/r-unsharp-mask-options.md)
...
+ Constantes da cadeia de caracteres {#sting-constants}
   + [Constantes da cadeia de caracteres](string-constants/c-string-constants/c-string-constants.md)
   + [Estados de Trabalho Ativo](string-constants/c-string-constants/r-active-job-states.md)
   + [Campos do sistema de pesquisa de ativos](string-constants/c-string-constants/r-asset-search-system-fields.md)
   + [Modos de substituição de ativos](string-constants/c-string-constants/r-asset-overwrite-modes.md)
   ...
   + [Canto de corte automático](string-constants/c-string-constants/r-auto-crop-corner.md)
   ...
   + [Estados do Acionador do Trabalho](string-constants/c-string-constants/r-job-trigger-states.md)
   ...
   + [Modos do espaço de cores PostScript](string-constants/c-string-constants/r-postscript-colorspace-modes.md)
   + [Classes de perfil](string-constants/c-string-constants/r-profile-classes.md)
   + [Estado de publicação](string-constants/c-string-constants/r-publish-state.md)
   ...
   + [Ordenar direções](string-constants/c-string-constants/r-sort-directions.md)
...
+ Log de alterações {#change-log}
   ...
   + Versão 6.0 {#version-6-0}
      ...
      + [Tipos de dados: Novo e modificado](change-log/c-change-log/c-6/r-6-types.md)
   + Versão 4.5 {#version-4-5}
      + [Versão 4.5](change-log/c-change-log/c-4-5/c-4-5.md)
      + [Operações: Novo e modificado](change-log/c-change-log/c-4-5/r-4-5-operations.md)
      + [Tipos de dados: Novo e modificado](change-log/c-change-log/c-4-5/r-4-5-types.md)
   ...
   + Versão 4.4 {#version-4-4}
      ...
      + [Operações: Novo e modificado](change-log/c-change-log/c-4-4/r-4-4-operations.md)
      + [Tipos de dados: Novo e modificado](change-log/c-change-log/c-4-4/r-4-4-types.md)
      + [Constantes da string: Novo e modificado](change-log/c-change-log/c-4-4/r-4-4-string-constants.md)
   + Versão 4.2 {#version-4-2}
      + [Versão 4.2](change-log/c-change-log/c-4-2/c-4-2.md)
      + [Tipos de dados: Novo e modificado](change-log/c-change-log/c-4-2/r-4-2-types.md)
   ...
   + Versão 3.8 {#version-3-8}
      ...
      + [Operações: Novo e modificado](change-log/c-change-log/c-3-8/r-3-8-operations.md)
      + [Tipos de dados: Novo e modificado](change-log/c-change-log/c-3-8/r-3-8-types.md)
      + [Constantes da string: Novo e modificado](change-log/c-change-log/c-3-8/r-3-8-string-constants.md)
   + Versão 3.7 {#version-3-7}
      ...
      + [Constantes da string: Novo e modificado](change-log/c-change-log/c-3-7/r-3-7-string-constants.md)
+ [Fazer upload de ativos por meio de HTTP POSTs para o UploadFile...](c-http-post.md)

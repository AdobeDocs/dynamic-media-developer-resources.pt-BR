...
+ Métodos de operação {#operation-methods}
   ...
   + Parâmetros de operação {#operation-parameters}
      ...
      + [addCompanyMember](operations/c-operations-intro/c-methods/r-add-company-membership.md)
      ...
      + [createDeriveAsset](operations/c-operations-intro/c-methods/r-create-derived-asset.md)
      ...
      + [getCompanyMember](operations/c-operations-intro/c-methods/r-get-company-membership.md)
      ...
      + [setCompanyMember](operations/c-operations-intro/c-methods/r-set-company-membership.md)
      ...
      + [setGroupMember](operations/c-operations-intro/c-methods/r-set-group-membership.md)
...
+ Tipos de dados {#data-types}
   ...
   + [EmpresaAssociação](types/c-data-types/r-company-membership.md)
   + [CompanyMembshipArray](types/c-data-types/r-company-membership-array.md)
   + [CompanyMembshipUpdate](types/c-data-types/r-company-membership-update.md)
   + [EmpresaMembshipUpdateArray](types/c-data-types/r-company-membership-update-array.md)
   ...
   + [ExcluirVídeoMestreDeAVS](types/c-data-types/r-exclude-master-video-from-avs.md)
   ...
   + [Palavras-chaveMatriz](types/c-data-types/r-keywords-array.md)
   ...
   + [EventoMPE](types/c-data-types/r-mp-event.md)
   ...
   + [OpçõesMiniaturas](types/c-data-types/r-thumbnail-options.md)
   + [DescompactarOpções](types/c-data-types/r-uncompress-options.md)
   + [UnsharMaskOptions](types/c-data-types/r-unsharp-mask-options.md)
...
+ Constantes de string {#sting-constants}
   ...
   + [Operadores de comparação de string](string-constants/c-string-constants/r-string-comparison-operators.md)
   + [Estado de lixo](string-constants/c-string-constants/r-trash-state.md)
...
+ Log de alterações {#change-log}
   ...
   + Versão 4.4 {#version-4-4}
      ...
      + [Constantes de string: Novo e modificado](change-log/c-change-log/c-4-4/r-4-4-string-constants.md)

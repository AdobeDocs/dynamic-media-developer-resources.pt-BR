...
Ative a notificação por email definindo como &quot;true&quot; e definindo as configurações de notificação por email. A configuração para `false` desativar todos os alertas de e-mail - isso pode ser útil quando um servidor é removido para manutenção. Booleano.
...
O endereço de email que deve ser usado no campo de email **[!UICONTROL De]** .

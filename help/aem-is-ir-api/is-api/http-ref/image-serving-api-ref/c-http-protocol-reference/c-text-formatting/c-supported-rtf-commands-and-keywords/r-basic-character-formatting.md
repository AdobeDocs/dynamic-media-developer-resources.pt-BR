 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p>O Servidor de imagens também reconhece os seguintes comandos RTF underline: </p> <p> 
     ...
     </ul> </p> <p>Eles são implementados neste momento como um padrão <span class="codeph"> \ul </span> sublinhando. Todos os outros comandos RTF sublinhados são ignorados. </p> </td> 
  </tr> 
  <tr> 

 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p>O Serviço de imagem também reconhece os seguintes comandos de sublinhado RTF: </p> <p> 
     ...
     </ul> </p> <p>Eles são implementados no momento como um padrão <span class="codeph"> \ul </span> sublinhado. Todos os outros comandos de sublinhado RTF são ignorados. </p> </td> 
  </tr> 
  <tr> 

...
O dimensionamento automático `text=`e `textPs=` as camadas têm aparência e posicionamento semelhantes.
...
Embora `text=` possa ser um pouco mais fácil de usar para aplicativos simples, o posicionamento preciso do `textPs=` oferta é independente das faces de fonte e dos efeitos de texto.
...
** `textPs=` não moverá o texto contendo as partes elevadas, resultando em um corte significativo se o texto estiver na camada 0:**

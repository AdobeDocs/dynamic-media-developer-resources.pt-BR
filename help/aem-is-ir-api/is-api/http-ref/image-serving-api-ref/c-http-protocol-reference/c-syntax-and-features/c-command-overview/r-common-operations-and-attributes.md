---
description: Esses comandos se aplicam a imagens, texto e camadas de cores sólidas. Geralmente, eles também são úteis para imagens compostas e solicitações de imagem simples e sem camadas.
seo-description: Esses comandos se aplicam a imagens, texto e camadas de cores sólidas. Geralmente, eles também são úteis para imagens compostas e solicitações de imagem simples e sem camadas.
...
Esses comandos se aplicam a imagens, texto e camadas de cores sólidas. Geralmente, eles também são úteis para imagens compostas e solicitações de imagem simples e sem camadas.
...
<table id="simpletable_996969D618C94BE8B81FAED512B5B7BA"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Desfoca a camada. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Ajusta o brilho da camada. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-op-colorbalance.md#reference-fb6af4ecf0f842d3adfdda342834a8fd" type="reference" format="dita" scope="local"> op_color_balance</a> </p></td> 
  <td class="stentry"> <p>Ajusta vermelho, verde, azul independentemente. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-op-colorize.md#reference-50399231d6dc4c15b3ab5b93c32c458a" type="reference" format="dita" scope="local"> op_colorizar</a> </p></td> 
  <td class="stentry"> <p>Coloriza os dados da camada. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Ajusta o contraste. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Alterna a matiz de todas as cores. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Inverter cores. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Adiciona ruído à camada. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Ajusta a saturação da cor. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Aplica uma nitidez simples. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Aplica máscaras incisivas. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Vira a camada na horizontal e/ou na vertical. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-rotate.md#reference-12abb086635546ec9ec2e1a793dc1096" type="reference" format="dita" scope="local"> girar</a> </p></td> 
  <td class="stentry"> <p>Gira a camada. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-perspective.md#reference-c941f3bb1eee4dd29abf3824c0b0bc8e" type="reference" format="dita" scope="local"> perspectiva</a> </p></td> 
  <td class="stentry"> <p>Transforme a camada em perspectiva. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Especifica formas de clipe para a camada. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Especifica formas de clipe invertido para a camada. </p></td> 
 </tr> 
</table>

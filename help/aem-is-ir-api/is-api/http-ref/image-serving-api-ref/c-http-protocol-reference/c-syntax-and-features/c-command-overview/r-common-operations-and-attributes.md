---
description: Esses comandos se aplicam a camadas de imagem, texto e cores sólidas. Eles também são geralmente úteis para imagens compostas e solicitações de imagens simples, sem camadas.
...
Esses comandos se aplicam a camadas de imagem, texto e cores sólidas. Eles também são geralmente úteis para imagens compostas e solicitações de imagens simples, sem camadas.
...
<table id="simpletable_996969D618C94BE8B81FAED512B5B7BA"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Colore os dados da camada. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Altera o matiz de todas as cores. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Perspectiva-transformar a camada. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Especifica a(s) forma(s) do clipe para a camada. </p></td> 
 </tr> 
 <tr class="strow"> 

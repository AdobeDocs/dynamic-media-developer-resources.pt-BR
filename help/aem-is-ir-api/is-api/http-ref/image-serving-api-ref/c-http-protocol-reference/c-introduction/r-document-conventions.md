...
<table id="simpletable_8C9DB0DA5F2B4C068794415602B768CB"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Nas seções de sintaxe, o texto em itálico é literal. Essa regra não se aplica ao espaço em branco e aos símbolos [ ] { } | *. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p>'literal' </p> </td> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> *[ <span class="varname"> opcional </span>] </span> </p> </td> 
  <td class="stentry"> <p>A variável <span class="varname"> opcional </span> o elemento de sintaxe não pode ser repetido nenhuma ou mais vezes. </p> </td> 
 </tr> 
 <tr class="strow"> 

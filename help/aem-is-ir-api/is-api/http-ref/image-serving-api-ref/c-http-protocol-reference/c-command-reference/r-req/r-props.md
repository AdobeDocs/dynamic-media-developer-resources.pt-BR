...
<table id="table_9665612ED7D24C07AAF75D953C0FEB36"> 
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> Cor do plano de fundo (Consulte <span class="codeph"> bgc= <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-bgc.md#reference-53376175f617446fbe5c69120f834b88" type="reference" format="dita" scope="local"> </a> </span>.) </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr> 
   ...
   <td> <p> booleano </p> </td> 
   <td> <p> True se o perfil ICC estiver incorporado na imagem de resposta. (Consulte <span class="codeph"> IccEmbed= <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-iccembed.md#reference-e3b774fb322046a2a6dde3a7bab5583e" type="reference" format="dita" scope="local"> </a> </span>.) </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> booleano </p> </td> 
   <td> <p> 1 se a imagem de resposta incorporar quaisquer caminhos, caso contrário, 0. (Consulte <span class="codeph"> caminho <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-pathembed.md#reference-9ccf0771d6634cf68c1c9c33cd428301" type="reference" format="dita" scope="local"> Incorporado= </a> </span>.) </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> integer </p> </td> 
   <td> <p> Qualidade JPEG. (Consulte <span class="codeph"> qlt= <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-is-http-qlt.md#reference-f69ed0758c784b0385d979820546d352" type="reference" format="dita" scope="local"> </a> </span>.) </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> <span class="codeph"> image.type </span> </p> </td> 
   <td> <p> string </p> </td> 
   <td> <p> Tipo de MIME para a imagem de resposta. (Consulte <span class="codeph"> fmt= <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-is-http-fmt.md#reference-cdf10043423b45ba9fe15157fb3ae37a" type="reference" format="dita" scope="local"> </a> </span>.) </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> booleano </p> </td> 
   <td> <p> 1 se a imagem de resposta incorporar dados xmp, caso contrário, 0. (Consulte <span class="codeph"> xmpEmbed= <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-xmpembed.md#reference-46ecf40a40a0442fa62de3a85dcb03e8" type="reference" format="dita" scope="local"> . </a> </span>.) </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> <span class="codeph"> image.version </span> </p> </td> 
   <td> <p> string </p> </td> 
   <td> <p> Identificador da versão da imagem. (Consulte <span class="codeph"> id= <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-id.md#reference-60661184deb3420998779724244fcfa0" type="reference" format="dita" scope="local"> </a> </span>.) </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> <span class="codeph"> metadata.version </span> </p> </td> 
   <td> <p> string </p> </td> 
   <td> <p> Identificador da versão de metadados. (Consulte <span class="codeph"> id= <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-id.md#reference-60661184deb3420998779724244fcfa0" type="reference" format="dita" scope="local"> </a> </span>.) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B66360C475CE495D9701AB526E758873"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> duplo </p> </td> 
   <td> <p> <span class="codeph"> estático::Expiração </span> ou o tempo padrão de vida </p> </td> 
  </tr> 
  <tr> 
   <td> <p> <span class="codeph"> lastModified </span> </p> </td> 
   <td> <p> string </p> </td> 
   <td> <p> Data/hora da modificação (de <span class="codeph"> static::TimeStamp </span> ou o arquivo de objeto) </p> </td> 
  </tr> 
  <tr> 

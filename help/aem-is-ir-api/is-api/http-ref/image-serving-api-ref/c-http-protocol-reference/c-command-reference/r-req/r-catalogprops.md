...
Para recuperar as propriedades padrão do catálogo ( [!DNL default.ini]), omita a ID do catálogo. A resposta HTTP pode ser armazenada em cache com o TTL com base em `attribute::NonImgExpiration`.

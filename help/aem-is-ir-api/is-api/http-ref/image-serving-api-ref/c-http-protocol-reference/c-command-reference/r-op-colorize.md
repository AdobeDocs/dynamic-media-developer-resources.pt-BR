...
Defina o *`contrast`* valor como 0 para preservar o intervalo de contraste da imagem de entrada ou especifique um intervalo de contraste desejado com um valor maior que 0. Um valor de 100 maximiza o contraste. Valores típicos podem estar entre 30 e 70.

Além dos ajustes integrados de brilho e contraste, `op_brightness=` e `op_contrast=` pode ser utilizado para ajustar ainda mais o efeito de colorização.
...
O *`contrast`* valor será ignorado se a compensação de brilho estiver desativada.
...
`None`, sem colorização. O segundo e o terceiro argumentos assumem como padrão `norm,0`, para compensação automática de brilho e sem alteração de contraste.

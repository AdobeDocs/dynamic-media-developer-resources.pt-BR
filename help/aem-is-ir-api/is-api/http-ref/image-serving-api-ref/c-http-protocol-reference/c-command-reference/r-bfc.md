...
<table id="simpletable_2D23B1B282CD4216AB5BE7E7430D1B3F"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Especifica se a funcionalidade de conversão do formato do navegador - conversão de imagens JPEG ou PNG em formatos de arquivo específicos do navegador menores - é verdadeira ( <span class="codeph"> em </span>) ou falso ( <span class="codeph"> desligado </span> para nenhuma conversão de formato específica do navegador). </p> </td> 
 </tr> 
</table>
...
[Bfc](../../../../../is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-bfc.md#reference-5217a41d9d7447d6b0624077eb38d3de), [dpr](/help/aem-is-ir-api/is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-dpr.md), [rede](/help/aem-is-ir-api/is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-network.md), [Imagem inteligente](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/dynamicmedia/imaging-faq.html?lang=en)

...
seo-description: Os arquivos de atributos de catálogo reconhecem esses atributos de gerenciamento de catálogo.
...
Os arquivos de atributos de catálogo reconhecem esses atributos de gerenciamento de catálogo.
...
<table id="simpletable_010A9494BFEB45F0A46FE9709E0404CA"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Nomes dos arquivos de dados SVG associados. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> Arquivo <a href="../../../../../../is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-staticcontentcatalogfile.md#reference-1d5505d9d1b74fe5ba63fbdf7893eb0d" type="reference" format="dita" scope="local"> StaticContentCatalog</a></span> </p></td> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Sequência de anotação do catálogo. </p></td> 
 </tr> 
 <tr class="strow"> 

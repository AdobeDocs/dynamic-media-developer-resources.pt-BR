---
description: Resolução da miniatura. Especifica a resolução do objeto para a imagem em miniatura.
...
Resolução da miniatura. Especifica a resolução do objeto para a imagem em miniatura.

Somente usado se `catalog::ThumbType=3`.

## Propriedades {#section-ee5cae086a3d4875805fa8a08756a586}

Valor de número real maior que 0. Deve ter as mesmas unidades que `catalog::Resolution`.

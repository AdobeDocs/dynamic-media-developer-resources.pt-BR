...
Valor da string de texto. É recomendável usar [dados de propriedade](/help/aem-is-ir-api/is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-common-data-types/r-property-data.md) formatação. Se a formatação de dados de propriedade não for usada, a cadeia de texto não deverá conter o caractere &#39;=&#39;.

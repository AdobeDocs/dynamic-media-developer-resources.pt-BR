...
O tipo de ativo determina que tipo de resposta gerar para `req=set` solicitações. Se um valor não for especificado, as regras de detecção automática determinam o tipo de `req=set` resposta.

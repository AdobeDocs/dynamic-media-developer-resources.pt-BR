...
+ [Página inicial da API de disponibilização de imagens e renderização de imagens do Dynamic Media](homeisir.md)<!-- (https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/image-serving-api/homeisir.html) -->
   ...
   + Referência de protocolo HTTP {#http-protocol-reference}
      ...
      + Sintaxe e recursos {#syntax-and-features}
         ...
         + Comando de protocolo HTTP do Servidor de imagens {#image-serving-http}
            ...
            + [Operações da imagem de origem](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/r-source-image-operations-and-attributes.md)

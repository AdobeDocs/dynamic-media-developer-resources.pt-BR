...
user-guide-title: API de disponibilização e renderização de imagem do Dynamic Media
breadcrumb-title: API de disponibilização e renderização de imagem do Dynamic Media
...
# API de disponibilização e renderização de imagem do Dynamic Media {#image-serving-api}

+ [Página inicial da API do Dynamic Media Image Serving and Image Rendering](homeisir.md)<!-- (https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/image-serving-api/home.html?lang=en) -->
...
+ Instalação {#install}
   ...
   + Instalar no Windows {#windows-install}
      + [Instalar no Windows](c-installation/t-installing-on-windows/t-installing-on-windows.md)
      ...
      + [Verificar a instalação](c-installation/t-installing-on-windows/t-verify-win.md)
   + Instalação no Linux {#linux-install}
      ...
      + [Verificar a instalação](c-installation/c-installing-linux/t-verify-install-lin.md)
   + Iniciando e parando o Serviço de Imagem {#start-stop-image-servicing}
      + [Iniciar e parar a exibição de imagens](c-installation/t-starting-and-stopping/t-starting-and-stopping.md)
      + [Iniciar ou parar no Windows](c-installation/t-starting-and-stopping/t-startstop-windows.md)
      + [Iniciar ou parar no Linux](c-installation/t-starting-and-stopping/t-startstop-linux.md)
+ API de disponibilização de imagens {#image-serving-api}
   ...
   + [Público-alvo pretendido](is-api/image-serving-api-ref/c-intended-audience.md)
   + [Componentes do Image Serving](is-api/image-serving-api-ref/r-components.md)
   + Configuração e administração {#config-admin}
      ...
      + Caches de dados {#data-caches}
         ...
         + [Cluster do cache](is-api/image-serving-api-ref/c-configuration-and-administration/c-data-caches/c-cache-clustering.md)
      + Configurações do servidor {#server-settings}
         ...
         + [Caches de servidores](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-server-caches.md)
         ...
         + [Registro de acesso](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-access-logging.md)
         + [Registro do Debug_trace](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-debug-trace-logging.md)
         ...
         + [Cluster do cache](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-cache-clustering.md)
         ...
         + [Respostas do conjunto de mídia](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-media-set-responses.md)
      + [Redirecionar para erro](is-api/image-serving-api-ref/c-configuration-and-administration/c-redirect-on-error.md)
      + [Configuração de SVG](is-api/image-serving-api-ref/c-configuration-and-administration/c-configuring-svg.md)
      ...
      + Gerenciamento de conteúdo {#manage-content}
         ...
         + [Dados da fonte de conteúdo estático](is-api/image-serving-api-ref/c-configuration-and-administration/c-managing-content/c-static-content-source-data.md)
   ...
   + [Fornecer conteúdo estático (não imagem)](is-api/image-serving-api-ref/c-serving-static-nonimage-contents.md)
   ...
   + Referência de protocolo HTTP {#http-protocol-reference}
      ...
      + Introdução ao protocolo HTTP {#http-protocol-introduction}
         ...
         + [Público-alvo pretendido](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-introduction/c-intended-audience.md)
      ...
      + Sintaxe e recursos {#syntax-and-features}
         ...
         + [Sintaxe básica do protocolo HTTP Image Serving](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-basic-syntax.md)
         + Comando do protocolo HTTP Image Serving {#image-serving-http}
            + [Visão geral do comando do protocolo HTTP de disponibilização de imagens](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/c-command-overview.md)
            + [Comandos da solicitação](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/r-request-commands-and-attributes.md)
            ...
            + [Comandos comuns de camada](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/r-common-layer-commands-and-attributes.md)
         ...
         + Camada {#layering}
            + [Visão geral da camada](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-layering-overview/c-layering-overview.md)
         ...
         + [Efeitos da camada](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-layer-effects.md)
         + [Solicitar aninhamento e incorporação](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-request-nesting-and-embedding.md)
         ...
         + [Suporte SVG](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-svg-support.md)
         + [Solicitar pré-processamento](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-request-preprocessing.md)
         + [Mapas de imagens](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-image-maps.md)
         + [Gerenciamento de cores do fornecimento de imagens](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-color-management.md)
         + [Codificação HTTP do Image Serving](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-http-encoding.md)
         ...
         + [Veiculação de conteúdo estático (não imagem)](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-serving-static-non-image-content.md)
      ...
      + Formatação de texto {#text-formatting}
         ...
         + [Tratamento de fontes](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/r-font-handling.md)
         ...
         + [Montagem de cópias](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/r-copy-fitting.md)
      ...
      + Referência de comando {#command-reference}
         ...
         + [effectiveMask](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-effectmask.md)
         ...
         + [virar](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-flip.md)
         ...
         + req {#req}
            ...
            + [mrSet](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-req/r-mbrset.md)
         ...
         + [gn](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-rgn.md)
      ...
      + Comportamento do servidor {#server-behavior}
         ...
         + [Inserção de camada](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-layer-placement.md)
         + [Exibir transformação de imagens](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-view-transform-for-images.md)
         + [Exibir transformação para miniaturas](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-view-transform-for-thumbnails.md)
      + Modelos {#templates}
   ...
   + Referência de protocolo do servidor FXG {#fxg-server-protocol-ref}
      ...
      + Protocolo do servidor FXG {#fxg-server-protocol}
         + [Protocolo do servidor FXG](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol.md)
         + Referência de protocolo do servidor FXG {#protocol-ref}
            ...
            + [conversionTextToOutlines](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol-reference/r-convertextoutlines.md)
         ...
         + Comandos de processamento em lote {#batch-process-commands}
            ...
            + [batchjobdetails status](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-batch-processing-commands/r-batchjobdetailedstatus.md)
   ...
   + Referência do catálogo de imagens {#image-catalog-reference}
      ...
      + Campos de dados do catálogo {#catalog-data-fields}
         ...
         + [Dados do Image_SVG](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-catalog-data-fields/r-image-svg-data.md)
      ...
      + Tipos de dados comuns {#common-data-types}
         ...
         + [Sequência de texto](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-common-data-types/r-text-string.md)
   ...
   + Atributos {#attributes}
      ...
      + [MiniaturaAlinhar](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-thumbhorizalign.md)
   ...
   + Referência de dados de imagem/SVG {#image-svg-ref}
      ...
      + Referência de dados da imagem {#image-data-reference}
         + [Referência de dados da imagem](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-image-data-reference/c-image-data-reference.md)
      ...
      + Dados de conteúdo estático {#static-content-data}
         + [Referência de dados do conteúdo estático](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-static-content-data-reference/c-static-content-data-reference.md)
   ...
   + [Exemplos de servidor de imagem](is-api/image-serving-api-ref/r-examples-is.md)
   + Biblioteca de imagem estática responsiva {#responsive-static-image-library}
...
+ API de renderização de imagem {#image-rendering-api}
   ...
   + Configuração {#configuration}
      ...
      + [Configurar e configurar a renderização de imagens](ir-api/image-rendering-api-ref/c-ir-installation/c-ir-setup-ir.md)
   ...
   + Administração do servidor {#server-administration}
      ...
      + Configuração e gerenciamento do servidor {#configuring-and-managing-the-server}
         ...
         + [Considerações de espaço em disco dinâmico](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-configuring-and-managing-the-server/c-ir-dynamic-disk-space-considerations.md)
      ...
      + Referência de configurações {#configuration-settings-reference}
         + [Visão geral da referência das configurações](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-configuration-settings-reference/c-ir-configuration-settings-reference.md)
         ...
         + [Pasta de cache de catálogo (ir.catalogCacheRoot)](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-configuration-settings-reference/c-ir-catalog-cache-folder.md)
   ...
   + Referência de protocolo HTTP {#http-protocol-reference}
      ...
      + Sintaxe e recursos do protocolo HTTP {#http-protocol-syntax}
         ...
         + Visão geral do comando Protocolo HTTP de renderização de imagem {#image-rendering-http-protocol-command-overview}
            + [Visão geral do comando Protocolo HTTP de renderização de imagem](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-command-overview/c-ir-command-overview.md)
         ...
         + Efeitos de renderização avançada {#advanced-render-effects}
            ...
            + [Uso de mapas de iluminação múltipla](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-advanced-render-effects/c-ir-use-multiple-illumination-maps.md)
            ...
            + [Efeitos de perda](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-advanced-render-effects/c-ir-gloss-effects.md)
         ...
         + Solicitar aninhamento e incorporação {#request-nesting-and-embedding}
            ...
            + [Solicitações do servidor de imagem incorporado](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-request-nesting-and-embedding/c-ir-embedded-image-serving-requests.md)
         ...
         + Catálogos de materiais {#material-catalogs}
            ...
            + [Catálogo de sessão](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-http-material-catalogs/r-ir-session-catalog.md)
         + [Solicitação de pré-processamento *](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-request-pre-processing.md)
         ...
         + [Gestão de cores da renderização de imagens *](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-color-management.md)
      ...
      + Referência de comando do protocolo HTTP {#http-protocol-command-reference}
         ...
         + [caldo](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-grout.md)
         ...
         + [copião](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-rough.md)
         ...
         + [nítido](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-http-sharp.md)
   ...
   + Catálogo de materiais {#material-catalog}
      ...
      + Referência de dados do material {#material-data-reference}
         ...
         + [Rigidez](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-roughness.md)
...
+ Utilitários {#utilites}
   ...
   + Conversor de vinheta (vntc){#vignette-converter-vntc}
      ...
      + [Conversor de vinhetas](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/c-ir-vignette-converter.md)

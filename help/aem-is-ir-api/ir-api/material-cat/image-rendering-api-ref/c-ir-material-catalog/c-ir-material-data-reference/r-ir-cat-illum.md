---
title: Illum
description: Seletor de mapa de iluminação. Ela permite a seleção explícita do mapa de iluminação a ser usado ao renderizar esse material.
...
Seletor de mapa de iluminação. Ela permite a seleção explícita do mapa de iluminação a ser usado ao renderizar esse material.
...
Defina como 0, 1 ou 2 para selecionar o mapa de iluminação A, B ou C. O renderizador escolhe o mapa de iluminação mais próximo disponível na vinheta.

...
Espaço de cores padrão CMYK. Especifica o nome do perfil de cores ICC a ser usado para imagens de resposta em escala de cinza quando nenhum espaço de cores de saída for especificado com `icc=`.

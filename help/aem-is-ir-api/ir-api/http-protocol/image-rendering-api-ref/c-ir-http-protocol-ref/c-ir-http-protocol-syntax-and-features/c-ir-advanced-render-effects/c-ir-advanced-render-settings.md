...
description: A Ferramenta de criação de vinheta (parte do pacote de criação de imagem do Dynamic Media) fornece mecanismos para controlar aspectos de baixo nível do mecanismo de renderização de vinheta.
...
A Ferramenta de criação de vinheta (parte do pacote de criação de imagem do Dynamic Media) fornece mecanismos para controlar aspectos de baixo nível do mecanismo de renderização de vinheta.
...
<table id="table_1517FC39C7344EBB9F17BE20415DB057"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col5"> <p>A0=Renderizar efeitos </p> <p>A1=Sombreador Alternativo </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>U </p> </td> 
   <td colname="col2"> <p>USM (Máscara UnSharp). </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Valor da USM (%). </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p> 
     <ul id="ul_87184BB93E7F46D59BA1AAAFA8455512"> 
      ...
      <li id="li_42ACFCE65B4843ACAFA6A52255364642">Superesamostragem (valor padrão) </li> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p> 
     <ul id="ul_FD4A9D73C32F47C3BF13776BB4D2818D"> 
      ...
      <li id="li_D334ACF969E749A89A464B21C96CE8A6">Superesamostragem </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Superamostragem: aleatória. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Supersampling: taxa aleatória. </p> </td> 
   <td colname="col3"> <p>1 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Poisson: Use a alternância. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>1 </p> </td> 
   <td colname="col5"> <p>O padrão é 1. </p> </td> 
  </tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Saturação da sombra. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Resistência à extrapolação com base em brilho. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p>O padrão é ativado (em branco) e desmarcado = F100G0. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ajuste de realces. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p>u e s </p> </td> 
   <td colname="col2"> <p>Desvio de matiz da sombra. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>Formato diferente: u8.1.2.3.4.5.6.7.8.s8.1.2.3.4.5.6.7.8. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>v e t </p> </td> 
   <td colname="col2"> <p>Realçar deslocamento de matiz. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Valores padrão na Criação de imagens. 
     <ul id="ul_AA7CF1A3E6984B318265BBE8FFFBB4EE">
      ...
      <li id="li_376C275FDB3548958C09BD266C77318F">J10 = Saturação dos realces (0-50). </li> 
      <li id="li_FE26429972F544869CDFE2DD61F39CC5">K200 = Saturação da sombra (0-400). </li> 
      <li id="li_FB6BAA708427428AA4A3AC2E5D3B9932">L400 = Resistência à extrapolação baseada em brilho (100-600). </li> 
      ...
      <li id="li_949B6DB4959B46A892787CD5B3AD7485">W100 = valor de USM (1%-500%). </li> 
      <li id="li_F39D3834D4A2478D993E5E9C9B434CFE">X0 = Limite de USM (0-255 níveis). </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7C374842312E4AD0B62692BBCE6743A8"> 
      <li id="li_CC730580B54741FBBBFF507DE0FE1F15">H80 = valor da USM </li> 
      <li id="li_C2801B2C093444AC9401793BC571EC27">I70 = Realces </li> 
      <li id="li_518C6A690EC34614B0806A0C6BC535FF">J40 = Saturação dos realces </li> 
      <li id="li_F280CF29D1E341D9AC9C0C16C2DEA1E6">L300 = Resistência à extrapolação baseada em brilho </li> 
      <li id="li_3F589F109AC94280911BD535C49E42E4">U1 = USM </li> 
      <li id="li_113FEC9B37D54511BAB3FEAC7C271858">V8 = raio do USM </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Sombreador Alternativo com nitidez: </p> <p> 
     <ul id="ul_93AD53BB37EA47F6A3CEE424D3AAE18C"> 
      ...
      <li id="li_7B5D8B7BB5544E7FA4AD702EE281086B">Quantidade de USM (120) </li> 
      <li id="li_B3BE096BB0654A2DBADDD6832E499F2A">Raio do USM (0,6) </li> 
      <li id="li_793DAB145CE7469ABC1182BCBD324657">Limite da USM (5) </li> 
      <li id="li_B1954FEBE2084726828D64E8165DA4DA">Redimensionamento (Lanczos) </li> 
      <li id="li_E5ED76998C0543D8A3F9AD178CFD3C2C">Reamostragem (superamostragem, random=half, rate=half) </li> 
      <li id="li_CCEE53544E7D48858398BF3168F1E87D">Contraste (mais forte) </li> 
      <li id="li_EB0D25C095FB4D5798AC031AB759849B">Ajuste de Saturação (primeiro vértice no meio, segundo vértice ao longo da borda, terceiro vértice ponto médio baixo) </li> 
      <li id="li_5C2304DA4A4D4799AE5DCCCB1E2ECBB3">Nitidez (3/4 à direita) </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>

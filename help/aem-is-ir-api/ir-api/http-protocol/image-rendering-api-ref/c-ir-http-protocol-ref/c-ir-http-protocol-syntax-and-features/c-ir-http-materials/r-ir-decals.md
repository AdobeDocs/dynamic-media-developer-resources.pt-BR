...
Um decal pode ser aplicado a cada objeto plano, flanfrado, rascunho, plano ou parede (a menos que o sinalizador &#39;Sem textura&#39; esteja definido). As recusas são aplicadas ao objeto ao alinhar as decais `anchor=` com o ponto de origem decal do objeto de vinheta. A posição pode ser ajustada com `pos=`.
...
<table id="table_3F119BC9B7654FD092826A34F5827268"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> <span class="varname"> imageWidth </span> x <span class="codeph"> res </span>, <span class="varname"> imageHeight </span> <span class="codeph"> x res, 0 </span> </p> </td> 
  </tr> 
  <tr> 

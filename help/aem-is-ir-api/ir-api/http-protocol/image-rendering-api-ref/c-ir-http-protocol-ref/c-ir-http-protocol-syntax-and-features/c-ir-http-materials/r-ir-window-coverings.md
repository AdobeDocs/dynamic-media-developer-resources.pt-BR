...
Os materiais de revestimento de janelas especificam um arquivo *de* janela que cobre o estilo (extensão de [!DNL .vnw] arquivo), um arquivo de dados especial semelhante a uma vinheta, contendo dados de máscara, iluminação, layout e textura que definem a cobertura da janela.

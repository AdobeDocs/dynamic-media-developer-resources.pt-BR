...
description: Os materiais de revestimento de janelas incluem coberturas de janelas suaves (cortinas, valanças, cortinas de café) e revestimentos de janelas duras (sombras e persianas).
...
Os materiais de revestimento de janelas incluem coberturas de janelas suaves (cortinas, valanças, cortinas de café) e revestimentos de janelas duras (sombras e persianas).

Materiais de revestimento de janelas especificam *arquivo de estilo de cobertura de janela* ( [!DNL .vnw] extensão de arquivo), um arquivo de dados especial semelhante a uma vinheta, contendo dados de máscara, iluminação, layout e textura que definem a cobertura da janela.

...
Materiais de revestimento de janelas especificar um *arquivo de estilo de revestimento de janela* ( [!DNL .vnw] extensão de arquivo), um arquivo de dados especial semelhante a uma vinheta, contendo máscara, iluminação, layout e dados de textura que definem a cobertura da janela.

[!DNL vnw] os arquivos não incluem a cor e a textura (malha) da cobertura da janela. Essas informações são especificadas separadamente, semelhantes às texturas repetíveis.
...
<table id="table_545865B054E84592BDAEDA57DBFAE9B3"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-src.md#reference-62c98abad22149d68d405ed6aaff8272" type="reference" format="dita" scope="local"> <span class="codeph"> src= </span> </a> </p> </td> 
   <td colname="col2"> <p>Arquivo de imagem de textura (segundo valor de <span class="codeph"> src= </span>). </p> </td> 
   <td colname="col3"> <p>Nenhum. </p> </td> 
  </tr> 
  <tr> 

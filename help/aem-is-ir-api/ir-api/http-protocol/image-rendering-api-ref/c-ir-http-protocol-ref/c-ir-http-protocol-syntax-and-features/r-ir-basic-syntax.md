---
description: Esta seção descreve a sintaxe básica do protocolo HTTP de renderização de imagem Dynamic Media.
seo-description: Esta seção descreve a sintaxe básica do protocolo HTTP de renderização de imagem Dynamic Media.
...
Esta seção descreve a sintaxe básica do protocolo HTTP de renderização de imagem Dynamic Media.

---
title: qlt
description: Qualidade do Jpeg. Especifica atributos de codificação do JPEG para controlar o nível de compactação.
...
Qualidade do Jpeg. Especifica atributos de codificação do JPEG para controlar o nível de compactação.
...
Especifica atributos de codificação do JPEG para controlar o nível de compactação. Por sua vez, isso varia o tamanho do arquivo (quantidade de dados de resposta) e, indiretamente, a qualidade visual da imagem resultante.

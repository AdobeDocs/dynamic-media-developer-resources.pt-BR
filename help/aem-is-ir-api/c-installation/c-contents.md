---
title: Conteúdo
description: Após a instalação, a hierarquia de pastas em install_root inclui os arquivos e pastas listados abaixo.
...
Após a instalação, a hierarquia de pastas em install_root inclui os arquivos e pastas listados abaixo.

>[!NOTE]
>
>Arquivos e pastas adicionais estão presentes; não os altere.

<table id="table_F9FE5E0622A54CCD88461078FD5EA3DC"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> <p>Instalar raiz </p> </th> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="filepath"> licenças </span> </p> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>Script para iniciar e parar o Servidor de imagens. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>Vinheta de renderização de imagem, gabinete e utilitário conversor de cobertura de janela. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> cache/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Pasta de caches de dados; configurável ao instalar ou editando manualmente os arquivos de configuração. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>O cache primário de resposta HTTP. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> catálogo/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>É a pasta de catálogos de imagens; configurável ao instalar ou editando manualmente os arquivos de configuração. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Todos os dados de registro PS e IS são gravados nessa pasta; edite manualmente os arquivos de configuração. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> <p> <span class="filepath"> access-*.log </span> </p> </td> 
   <td colname="col4"> <p>Logs de acesso HTTP. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> <p> <span class="filepath"> ImageServer-*.log </span> </p> </td> 
   <td colname="col4"> <p>Logs de depuração/erro do Servidor de imagens. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>Registros de erro/depuração do PS. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> ferramentas/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="filepath"> catálogo/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Pasta Catálogos de renderização de imagem; configurável ao instalar ou editando manualmente os arquivos de configuração. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Pasta de dados de origem da Renderização de imagem; edite manualmente os arquivos de configuração. </p> </td> 
  </tr> 
 </tbody> 
</table>

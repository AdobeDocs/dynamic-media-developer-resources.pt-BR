...
Notas de versão que descrevem os recursos, aprimoramentos e correções do Sistema de publicação Adobe Scene7 6.0 - parte do Adobe Marketing Cloud.
...
<!--       [More information](http://help.adobe.com/pt_BR/scene7/using/WS662101DF-D697-47a7-A7D8-B52FD8E94438.html). -->

**Gerenciamento e publicação de ativos**

* Fluxo de trabalho de publicação de ativos aprimorado. <!-- [More information](http://help.adobe.com/pt_BR/scene7/using/WS3673AD39-098B-4f08-8A24-CA51261B7366.html). -->
* Aprimoramento da usabilidade da visualização do modelo. Consulte o seguinte para obter mais informações:

<!--
   [Configuring default viewers](http://help.adobe.com/pt_BR/scene7/using/WS98ca2e6790647c06-76b2d0e0135685cd4a8-8000.html)

  [Previewing an asset based on viewer platform type](http://help.adobe.com/pt_BR/scene7/using/WS98ca2e6790647c06-2ce305113564963202-7fff.html)

  [Previewing an image asset based on its image preset](http://help.adobe.com/pt_BR/scene7/using/WS98ca2e6790647c06-2ce305113564963202-7ffe.html)
  -->

* Após esta versão, um novo recurso de Publicação instantânea será lançado gradualmente. Esse recurso substitui a funcionalidade atual &quot;Marcar para publicação&quot;. Alguns usuários podem ver a nova funcionalidade antes de outros. A documentação do SPS e os elementos da interface do usuário estão planejados para atualização quando o período de implantação estiver próximo da conclusão. Você pode planejar receber um email com mais detalhes quando a implantação começar.

**Visualizadores**

* Adição de suporte à localização para o texto de dica de ferramenta nas Predefinições do visualizador do Flash AS3 e HTML5.
...
<!--   [More information](http://help.adobe.com/pt_BR/scene7/using/WS98ca2e6790647c06-2ce305113564963202-7fff.html) -->

* Novos componentes abrangentes do visualizador no HTML5 SDK. (Consulte o arquivo Readme do SDK do HTML 5 incluído com o instalador para obter mais detalhes.)
* Flash SDK aprimorado. (Consulte o Leiame do Flash SDK incluído com o instalador para obter mais detalhes.)
* Os novos visualizadores do Flash AS3 incluem o seguinte:
...
* Adição de suporte de globalização para visualizadores, incluindo localização de texto e gráficos. Consulte os guias do usuário do Flash ou do HTML5 Viewer SDK incluídos no instalador do SDK.
* Interatividade adicionada aos eCatalogs com vídeo incorporado e visualizadores de rotação.
* Acesso simplificado aos SDKs do visualizador do Flash e do HTML5 no Adobe Developer Connection. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WSd4272150f67705c11b002eec12fcba4dee6-8000.html). -->
...
* Integração com o Adobe CQ5: sincronização de ativos, visualizadores do Scene7 incorporados ao CQ5 e entrega dinâmica de conteúdo de mídia avançada em páginas do CQ5 por meio da rede Scene7.
...
* Compile dinamicamente o conteúdo de origem do Flash (FLA) do banner dinâmico em filmes animados do GIF, incluindo o gerenciamento avançado de quadros. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WSd968ca97bf00cf72-5eedd3a113268dc80f4-8000.html).  -->
* Manipular dinamicamente distorções de deformação criadas com o Adobe Illustrator na Web do Scene7 para Imprimir fluxo de trabalho online. <!-- [More information](http://help.adobe.com/pt_BR/scene7/using/WSef8d5860223939e2-d19776312a7267a200-8000.html#WSd968ca97bf00cf72-5eedd3a113268dc80f5-8000). -->

**eVideo**

* Tempo de retorno de desempenho aprimorado para a transcodificação de vídeos.
* Predefinições simplificadas de vídeo de desktop usando os mesmos fps do vídeo de origem. <!-- [More information](http://help.adobe.com/pt_BR/scene7/using/WSE86ACF2B-BD50-4c48-A1D7-9CD4405B62D0.html#WS1c46793299cf21d7-39fae9c1131ba8968f7-7fff).  -->
...
* Transmissão contínua do iOS para vídeo UGC (User-Generated Content, conteúdo gerado pelo usuário). <!-- [More information](http://help.adobe.com/pt_BR/scene7/using/WSe8b0455615e2dc47-2df907a712f31201b35-8000.html). -->
...
* Esquemas de metadados
  ...
  Os esquemas de metadados definem conjuntos de propriedades de metadados. Cada propriedade do esquema de metadados tem um tipo de dados básico como String, Float, Integer, Date ou Yes/No. Também é possível definir listas, opções abertas ou opções fechadas. Os esquemas de metadados podem ser usados em todos os workflows de metadados, como pesquisa, edição, importação, visualizações de metadados e predefinições de metadados. <!-- [More information](http://help.adobe.com/pt_BR/scene7/using/WS259993e42159a215-1c6a66df1265272619e-7fec.html#WSd968ca97bf03cf72-5e3dd3a113268dc80f5-8000). -->
...
* O servidor de metadados expõe um subconjunto de todos os campos de metadados de um ativo para um servidor voltado para o público e pode ser solicitado aqui por páginas eCom ou servidores. Esses metadados expostos podem ser um conjunto combinado de propriedades de propriedades de ativos, UDFs, XMP e esquema de metadados. O servidor de metadados oferece uma API da WEB com vários recursos de pesquisa, como pesquisas de metadados, similaridade de imagem ou ambos. Para cada ativo retornado, uma lista de propriedades de metadados é solicitada.
* A importação de metadados pode lidar com propriedades do XMP

  A importação de metadados é estendida para lidar com propriedades e propriedades do XMP, definidas em Esquemas de metadados.
* Exibição de metadados para exibir apenas campos que contêm valores

  Existe uma nova visualização de metadados predefinida chamada &quot;Todas as propriedades com valores&quot; que mostra somente as metapropriedades que contêm valores. As propriedades (do XMP, Campos definidos pelo usuário ou dos novos Esquemas de metadados) sem valores são ocultas e não são exibidas.

...
Consulte também [Guia de referência do visualizador](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/home.html).
...
* **Aviso de Fim da Vida Útil dos Visualizadores de FlashesA partir de 31 de janeiro de 2017, o Adobe Scene7 (agora Dynamic Media Classic) encerrou oficialmente o suporte para a plataforma do visualizador de Flashes.** **
...
* Vídeo UGC está obsoleto nesta versão devido à baixa adoção. A configuração de outra conta do Dynamic Media Classic pode servir como uma solução de substituição para Vídeo UGC. Entre em contato com o suporte técnico da Adobe para ter outra conta configurada.

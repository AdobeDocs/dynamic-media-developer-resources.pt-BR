---
description: As notas de versão mais recentes que descrevem os novos recursos, melhorias e correções do Adobe Scene7 Publishing System 6.10-parte da solução Adobe Experience Manager no Adobe Marketing Cloud.
seo-description: As notas de versão mais recentes que descrevem os novos recursos, melhorias e correções do Adobe Scene7 Publishing System 6.10-parte da solução Adobe Experience Manager no Adobe Marketing Cloud.
...
As notas de versão mais recentes que descrevem os novos recursos, melhorias e correções do Adobe Scene7 Publishing System 6.10-parte da solução Adobe Experience Manager no Adobe Marketing Cloud.
...
* **Tipo** de pesquisa - Capacidade de adicionar propriedade de empresa para permitir o padrão do tipo de pesquisa pessoal **[!UICONTROL Contains]**.
   ...
   Em **[!UICONTROL Setup]** > **[!UICONTROL Personal Setup]** grupo > **[!UICONTROL Browser]** cabeçalho > lista suspensa **[!UICONTROL Basic Search Type]** - **[!UICONTROL Contains]**.
...
Em **[!UICONTROL Application Setup]** > **[!UICONTROL General Settings]** grupo > **[!UICONTROL Other Settings, to Application]** grupo > lista suspensa **[!UICONTROL Default Basic Search Type for New Users]** .
...
* **Novas configurações adicionadas aos visualizadores** HTML5 Spin Set predefinidos - em **[!UICONTROL Setup]** > **[!UICONTROL Application Setup]** > **[!UICONTROL Viewers]** > **[!UICONTROL Viewer Presets]** > ou `Universal_HTML5_SpinSet_dark` , as seguintes adições foram feitas à respectiva `Universal_HTML5_SpinSet_light`[!DNL Configure Viewer] página do visualizador:
...
Consulte também Guia [de referência](https://docs.adobe.com/content/help/en/dynamic-media-developer-resources/library/home.html)dos visualizadores.
...
* Interface do usuário de configuração implementada para criar e atualizar campos de metadados de tipo de tag. O suporte para o **[!UICONTROL Metadata Field Types]** no `fieldType` parâmetro inclui `SingleFixedTag` e apenas `BooleanTag` .

* Alterado `@scene7.com` para `@adobe.com` no endereço Enviar email.

* Adicionada a opção do tipo Publicação de disponibilização de imagem.
...
* Ocorreu um erro ao adicionar um campo definido pelo usuário ( **[!UICONTROL Setup]** > **Metadados** > Campo **definido pelo** usuário) do tipo `Boolean`, um valor de `true`e, em seguida, salvou-o.

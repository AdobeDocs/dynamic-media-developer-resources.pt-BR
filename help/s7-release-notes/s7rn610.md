...
* **Novas configurações adicionadas aos HTML5 eCatalog Viewers** prontos para uso - Em **[!UICONTROL Setup]** > **[!UICONTROL Application Setup]** > **[!UICONTROL Viewer Presets]** > `Universal_HTML5_eCatalog` ou `Universal_HTML5_eCatalog_Adv`, as seguintes adições foram feitas às respectivas [!DNL Configure Viewer] páginas de cada visualizador:
...
* **Novas configurações adicionadas aos Visualizadores de Conjuntos de Mídias Mistas HTML5 prontos para uso** - Em **[!UICONTROL Setup]** > **[!UICONTROL Application Setup]** > **[!UICONTROL Viewer Presets]** > `Universal_HTML5_MixedMedia_dark` ou `Universal_HTML5_MixedMedia_light`, as seguintes adições foram feitas às respectivas páginas [!DNL Configure Viewer] de cada visualizador:
...
* Opção de Ressincronização do servidor de catálogo na Validação IPS Classic Publish - removida.
...
**Novos recursos, melhorias e correções de erros do SDK 2.9.2 do Visualizador do Scene7 HTML5**
...
* As configurações do Publish não mostravam perfis de cores da empresa Scene7 Shared Assets.
...
* `clientAddressFilter` malformado estava causando uma exceção do servidor de catálogo ao usar as configurações do Publish do Servidor de Imagens de Teste Seguro.
...
* Adicionada a opção de tipo Publish do Servidor de imagens.
...
* **Aviso de Fim de Vida Útil de Visualizadores do Flash** *A partir de 31 de janeiro de 2017, o Adobe Scene7 (agora Dynamic Media Classic) encerrou oficialmente o suporte para a plataforma de visualizador do Flash.*

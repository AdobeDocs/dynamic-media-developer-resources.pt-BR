...
<table id="table_69203DAA18F94A0F927BBA00634EBF65"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Pesquisa a partir do início da cadeia de caracteres e retorna resultados de pesquisa mais rápido que <span class="uicontrol"> Contém </span>. </p> <p>Ele substitui o padrão definido na lista suspensa <span class="uicontrol"> &gt; </span> Configurações Gerais <span class="uicontrol"> grupo &gt; </span> Outras Configurações, para o grupo <span class="uicontrol"> do Aplicativo &gt; </span> Tipo de Pesquisa Básica Padrão para Novos Usuários <span class="uicontrol"> pelo Administrador.</span> </p> </td>
  </tr>
 </tbody>
</table>
...
<table id="table_65BA9F98D1D041109A44B1C130EF4EFA"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>A guia inclui uma configuração <span class="uicontrol"> de qualidade de impressão </span> que permite especificar o tamanho máximo da imagem enviada para a impressora. O padrão é <span class="codeph"> 1000 </span>. </p> </td>
  </tr>
  <tr> 
...
<table id="table_023203E3CC484F59A350C3C333EF817F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Permite configurar o tipo da animação de zoom a ser usada. No painel à esquerda, clique em <span class="uicontrol"> Recursos do Visualizador </span> para acessar as seguintes opções de <span class="uicontrol"> do modo de Zoom </span> na lista suspensa: </p> <p> 
...
* Remoção do uso do estilo de visibilidade :visible em componentes SDK.
...
* Fixo - ZoomView - zoom e panorâmica quebrados no IE se o max-width:100% for definido para IMGs no CSS.
* Eventos de status adicionais foram adicionados.

---
description: As notas de versão mais recentes que descrevem os recursos, os aprimoramentos e as correções mais recentes do Adobe Scene7 Publishing System 6.8-parte da solução Adobe Experience Manager no Adobe Marketing Cloud.
seo-description: As notas de versão mais recentes que descrevem os recursos, os aprimoramentos e as correções mais recentes do Adobe Scene7 Publishing System 6.8-parte da solução Adobe Experience Manager no Adobe Marketing Cloud.
...
As notas de versão mais recentes que descrevem os recursos, os aprimoramentos e as correções mais recentes do Adobe Scene7 Publishing System 6.8-parte da solução Adobe Experience Manager no Adobe Marketing Cloud.

## Notas de versão do Scene7 Publishing System 6.8 (maio de 2014) {#topic-4517aab837ea4d6d8204425958860e5a}

As notas de versão mais recentes que descrevem os recursos, melhorias e correções mais recentes para [!DNL Adobe Scene7 Publishing System] 6,8 partes da solução de Adobe Experience Manager no [!DNL Adobe Marketing Cloud].
...
* A Empresa do rótulo não é totalmente exibida na página Instalação do Adobe Analytics.

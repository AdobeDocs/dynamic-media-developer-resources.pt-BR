...
* Converter e-mail de senha esquecida de HTML em texto sem formatação para evitar a lista negra.
...
* Fixo: `selectSwatch` método não é acionado quando incorporado na `initViewer()` função.

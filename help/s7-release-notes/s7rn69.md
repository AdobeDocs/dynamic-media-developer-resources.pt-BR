...
* Testes seguros para solicitações do servidor de renderização - o teste seguro para ativos de serviço de imagem principal e ativos de vídeo agora é estendido para incluir também vinhetas. Consulte [Testar ativos antes de torná-los públicos](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/upload-publish/testing-assets-making-them-public.html#upload-publish).

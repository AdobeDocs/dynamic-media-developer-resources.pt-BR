---
description: As notas de versão mais recentes da solução Adobe Experience Manager da Adobe Dynamic Media Classic na Adobe Experience Cloud.
seo-description: As notas de versão mais recentes da solução Adobe Experience Manager da Adobe Dynamic Media Classic na Adobe Experience Cloud.
...
As notas de versão mais recentes da solução Adobe Experience Manager da Adobe Dynamic Media Classic na Adobe Experience Cloud.

## Notas de versão do Dynamic Media {#topic-1f5af440670a42f3bbb662eb86a196c6}

As notas de versão mais recentes da Adobe Dynamic Media Classic-parte da [!DNL Adobe Experience Manager] solução no [!DNL Adobe Experience Cloud].
...
* Vídeo HTML5
   ...
   * As legendas de vídeo exigem um conjunto de regras de empresa se a hospedagem da página HTML for fornecida por um servidor externo (não por um servidor Dynamic Media). Entre em contato com o suporte da Adobe para obter ajuda.

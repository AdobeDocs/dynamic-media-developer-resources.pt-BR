...
seo-description: As notas de versão mais recentes do Adobe Dynamic Media Classic, parte da solução Adobe Experience Manager na Adobe Experience Cloud.
seo-title: Notas de versão do Dynamic Media
...
As notas de versão mais recentes do Adobe Dynamic Media Classic, parte da solução Adobe Experience Manager na Adobe Experience Cloud.

## Notas de versão do Dynamic Media {#topic-1f5af440670a42f3bbb662eb86a196c6}

As notas de versão mais recentes do Adobe Dynamic Media Classic - parte da [!DNL Adobe Experience Manager] solução no [!DNL Adobe Experience Cloud].
...
* [Dynamic Media Image Server 6.3.2 e Image Rendering 6.3.2](s7rn2017.md#section-19a3e96f52c74757bcdea0f8a11001f2)
...
Para obter a documentação completa, consulte [http://help.adobe.com/en_US/scene7/using/index.html](http://help.adobe.com/en_US/scene7/using/index.html)
...
Para obter a documentação completa, consulte Guia [de referência do visualizador de mídia](https://marketing.adobe.com/resources/help/en_US/s7/viewers_ref/)dinâmica.
...
* Vídeo HTML5
   ...
   * As legendas de vídeo exigem um conjunto de regras de empresa se a hospedagem da página HTML for fornecida de um servidor externo (não de um servidor de Dynamic Media). Entre em contato com o suporte da Adobe para obter ajuda.
...
## Dynamic Media Image Server 6.3.2 e Image Rendering 6.3.2 {#section-19a3e96f52c74757bcdea0f8a11001f2}
